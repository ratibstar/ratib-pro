<?php
/**
 * EN: Handles configuration/runtime setup behavior in `config/migrations/check_rateb_pro_login.php`.
 * AR: يدير سلوك إعدادات النظام وتهيئة التشغيل في `config/migrations/check_rateb_pro_login.php`.
 */
/**
 * Diagnostic: Check why RATEB Pro login might fail.
 * Run from browser: https://rateb.sa/config/migrations/check_rateb_pro_login.php
 */
...
echo "=== RATEB Pro Login Diagnostic ===\n\n";
echo "OK:\n" . implode("\n", $ok) . "\n\n";
if (!empty($issues)) {
    echo "Issues:\n" . implode("\n", $issues) . "\n\n";
}
