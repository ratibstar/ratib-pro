 ...
 * https://rateb.sa/pages/rateb-rebrand-status.php
 */
...
require_once __DIR__ . '/../includes/rateb-site-content-rebrand-sanitize.php';

$build = trim((string) (@file_get_contents(__DIR__ . '/../public/rateb-build.txt') ?: ''));
$sanitizeFile = __DIR__ . '/../includes/rateb-site-content-rebrand-sanitize.php';
...
$bad = [];
foreach (['RATEB Company', 'RATEB Software Foundation', 'Rateb Software Foundation', 'Software Foundation for Information Technology', 'TRACKING INTELLIGENCE', 'Tracking Intelligence', 'Workforce Intelligence', 'RATEB — Recruitment Automation & Tracking'] as $needle) {
    foreach ($flat as $k => $v) {
