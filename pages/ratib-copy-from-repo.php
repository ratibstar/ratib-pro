...
if ($source === null) {
    ...
    echo "Upload files manually to public_html OR fix GitHub fetch (see ratib-profile-check.php).\n";
    exit(1);
}
...
$chromeSample = is_file($root . '/includes/ratib-home-public-chrome-top.php')
