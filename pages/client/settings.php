...
$clientProfileUrl = htmlspecialchars(rateb_client_dashboard_context_url('settings.php', 'section=profile'), ENT_QUOTES, 'UTF-8');
...
?>
            <div class="rateb-cp-split">
                <section class="rateb-cp-card">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a class="rateb-cp-pillbtn justify-content-center" href="<?php echo $clientProfileUrl; ?>">Profile</a>
                        <a class="rateb-cp-pillbtn justify-content-center" href="<?php echo $panelSettingsUrl; ?>" target="_blank" rel="noopener noreferrer">Control panel settings</a>
                        <a class="rateb-cp-pillbtn justify-content-center" href="<?php echo $systemSettingsUrl; ?>" target="_blank" rel="noopener noreferrer">System settings (role gated)</a>
                    </div>
                </section>
                <section class="rateb-cp-card">
                    <h2>Team controls</h2>
            ...
            <section id="client-settings-profile" class="rateb-cp-card mt-4">
                ...
                <div class="rateb-cp-quick mt-3" role="group" aria-label="Settings ownership actions">
                    <a class="rateb-cp-pillbtn" href="<?php echo $panelSettingsUrl; ?>" target="_blank" rel="noopener noreferrer">Open control panel settings</a>
                    <a class="rateb-cp-pillbtn" href="<?php echo $systemSettingsUrl; ?>" target="_blank" rel="noopener noreferrer">Open gated system settings</a>
                </div>
            </section>
<?php
