...
$RCP_EXTRA_JS = [ratib_client_dashboard_asset_url('js/client-dashboard-security.js')];
require __DIR__ . '/_common-start.inc.php';
?>
            <div class="ratib-cp-split">
                <section class="ratib-cp-card" id="rcp-security-overview">
                ...
                <section class="ratib-cp-card">
                    ...
                    <div class="ratib-cp-timeline" role="list" id="rcp-security-feed">
