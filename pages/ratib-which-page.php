...
function ratib_which_fetch(string $url): string
{
    ...
    curl_setopt_array($ch, [
        ...
        CURLOPT_TIMEOUT => 30,
        CURLOPT_USERAGENT => 'RatibWhichPage/1',
...
$profileHtml = ratib_which_fetch($base . '/profile/?_r=' . time());
$homeHtml = ratib_which_fetch($base . '/pages/home.php?_r=' . time());

$profileOk = str_contains($profileHtml, 'ratib-profile-distinct-banner')
    && str_contains($profileHtml, 'RATIB <span class="ratib-about-gradient">operations platform</span>');
...
<body>
    ...
    <div class="card <?php echo $profileOk ? 'ok' : 'bad'; ?>">
        ...
        <p>You must see: top banner, headline <strong>RATIB operations platform</strong>, bottom-right badge <strong>COMPANY PROFILE</strong>.</p>
    ...
    <div class="card ok">
        ...
        <a class="btn btn-purge" href="<?php echo htmlspecialchars($base . '/pages/ratib-purge-cache.php?key=ratib-deploy-sync-2026', ENT_QUOTES, 'UTF-8'); ?>">Purge LiteSpeed cache</a>
    </div>
</body>
</html>
