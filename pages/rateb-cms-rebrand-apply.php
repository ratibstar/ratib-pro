<?php
/**
 * One-shot: persist RATEB rebrand over stale rateb_site_content rows + purge snapshot cache.
 *
 * https://rateb.sa/pages/rateb-cms-rebrand-apply.php?key=rateb-deploy-sync-2026
 * https://rateb.sa/pages/rateb-cms-rebrand-apply.php?key=rateb-deploy-sync-2026&dry=1
 */
...
$expectedKey = 'rateb-deploy-sync-2026';
...
$stats = rateb_site_content_rebrand_persist_stale_keys($defaults);
