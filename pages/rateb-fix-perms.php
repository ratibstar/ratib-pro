 ...
 * https://rateb.sa/pages/rateb-fix-perms.php?run=1&key=rateb-deploy-sync-2026
...
if (!isset($_GET['run']) || (string) $_GET['run'] !== '1' || !hash_equals('rateb-deploy-sync-2026', $key)) {
    http_response_code(403);
    echo "Use: ?run=1&key=rateb-deploy-sync-2026\n";
    exit;
}

$root = dirname(__DIR__);
echo "rateb-fix-perms\n";
echo 'root=' . $root . "\n";
...
echo "Then: /pages/rateb-profile-deploy.php?deploy=1&key=rateb-deploy-sync-2026\n";
echo "DELETE pages/rateb-fix-perms.php when done.\n";
