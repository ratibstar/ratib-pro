            ...
            <form id="regForm" dir="ltr">
                ...
                <div id="paymentBlockWrap" class="payment-block-wrap mb-4 <?php echo ($plan !== 'pro' && $planAmount) ? '' : 'is-hidden'; ?>">
                    ...
                    <div class="mb-4 payment-summary-box payment-summary-panel">
                        ...
                        <p class="small mb-0 mt-2 ratib-ngenius-currency-note">Card checkout is charged in <strong><?php echo htmlspecialchars($__gatewayCurrency, ENT_QUOTES, 'UTF-8'); ?></strong>. Approximate in <?php echo htmlspecialchars($ratibDisplayCheckoutCurrency, ENT_QUOTES, 'UTF-8'); ?>: <strong><?php echo htmlspecialchars($ratibDisplayCheckoutCurrency, ENT_QUOTES, 'UTF-8'); ?> <?php echo number_format($__displayTotal, 2); ?></strong> <span class="ratib-ngenius-rate-note">(USD × <?php echo htmlspecialchars(number_format($ratibDisplayUsdRate, 2), ENT_QUOTES, 'UTF-8'); ?>)</span>.</p>
                        <?php else: ?>
                        <p class="small mb-0 mt-2 ratib-ngenius-currency-note">Card checkout is charged in <strong><?php echo htmlspecialchars($__gatewayCurrency, ENT_QUOTES, 'UTF-8'); ?></strong>. Approximate total: <strong class="ratib-ngenius-sar-total"><?php echo htmlspecialchars($__gatewayCurrency, ENT_QUOTES, 'UTF-8'); ?> <?php echo number_format($__gatewayTotal, 2); ?></strong> <span class="ratib-ngenius-rate-note">(USD × <?php echo htmlspecialchars(number_format($__gatewayRate, 2), ENT_QUOTES, 'UTF-8'); ?>)</span>.</p>
                        <?php endif; ?>
                        <?php } ?>
                    </div>
