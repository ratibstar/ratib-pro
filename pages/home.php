...
$ratibPhoneDisplay = function_exists('ratib_site_content_phone_display_for_public')
    ? ratib_site_content_phone_display_for_public($ratibPhoneRaw, $ratibPhoneDigits)
    : $ratibPhoneRaw;
    ...
    <div class="ratib-topbar">
        <div class="ratib-topbar__inner ratib-container">
            <div class="ratib-topbar__left">
                <a href="tel:+<?php echo htmlspecialchars($ratibPhoneDigits, ENT_QUOTES, 'UTF-8'); ?>" class="ratib-topbar__link" dir="ltr"><i class="fas fa-phone-alt" aria-hidden="true"></i> <span class="ratib-topbar__phone-text"><?php echo htmlspecialchars($ratibPhoneDisplay, ENT_QUOTES, 'UTF-8'); ?></span></a>
        ...
        <div class="ratib-container ratib-footer-enterprise__grid">
            ...
            <div class="ratib-footer-col">
                ...
                <ul>
                    ...
                    <li><a href="tel:+<?php echo htmlspecialchars($ratibPhoneDigits, ENT_QUOTES, 'UTF-8'); ?>" dir="ltr"><span class="ratib-topbar__phone-text"><?php echo htmlspecialchars($ratibPhoneDisplay, ENT_QUOTES, 'UTF-8'); ?></span></a></li>
                </ul>
            </div>
            <div class="ratib-footer-col">
