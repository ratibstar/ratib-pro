...
final class ProductFamilyController
{
    public function __construct(
        private readonly ProductFamilyService $familyService
    ) {
    }
    ...
    public function index(array $params = []): void
    {
        ...
        try {
            ...
            $result = $this->familyService->list($limit, $offset);
    ...
    {
        try {
            $result = $this->familyService->getByUuid($params['uuid']);
            if ($result['item'] === null) {
                ApiEnvelope::error([['message' => 'Product family not found']], 404, $result['meta']);
