...
<div class="admin-panel mt-3" id="sfCreatePanel" hidden>
    <form id="sfCreateForm">
        <div class="admin-form-grid">
            ...
            <div><label class="form-label">Entity type</label><input class="form-control" name="entity_type" value="product" required></div>
        </div>
        <label class="form-label mt-2">Filter JSON</label>
