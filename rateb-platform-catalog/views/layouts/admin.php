...
window.RatebAdminConfig = {
    ...
    i18n: {
        ...
        status: <?= json_encode(catalog__('field_status', $locale), JSON_UNESCAPED_UNICODE) ?>,
        service: <?= json_encode($locale === 'ar' ? 'الخدمة' : 'Service', JSON_UNESCAPED_UNICODE) ?>,
        version: <?= json_encode(catalog__('field_version', $locale), JSON_UNESCAPED_UNICODE) ?>,
        ...
        raw_json: <?= json_encode(catalog__('admin_raw_json', $locale), JSON_UNESCAPED_UNICODE) ?>,
        ...
        name: <?= json_encode(catalog__('field_name', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_sku: <?= json_encode(catalog__('field_sku', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_name: <?= json_encode(catalog__('field_name', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_status: <?= json_encode(catalog__('field_status', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_category: <?= json_encode(catalog__('field_category', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_uuid: <?= json_encode(catalog__('field_uuid', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_brand: <?= json_encode(catalog__('field_brand', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_family: <?= json_encode(catalog__('field_family', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_unit: <?= json_encode(catalog__('field_unit', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_slug: <?= json_encode(catalog__('field_slug', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_code: <?= json_encode(catalog__('field_code', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_url: <?= json_encode(catalog__('field_url', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_type: <?= json_encode(catalog__('field_type', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_entity: <?= json_encode(catalog__('field_entity', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_score: <?= json_encode(catalog__('field_score', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_amount: <?= json_encode(catalog__('field_amount', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_currency: <?= json_encode(catalog__('field_currency', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_channel: <?= json_encode(catalog__('field_channel', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_barcode: <?= json_encode(catalog__('field_barcode', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_short_description: <?= json_encode(catalog__('field_short_description', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_description: <?= json_encode(catalog__('field_description', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_parent: <?= json_encode(catalog__('field_parent', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_depth: <?= json_encode(catalog__('field_depth', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_path: <?= json_encode(catalog__('field_path', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_sort_order: <?= json_encode(catalog__('field_sort_order', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_image: <?= json_encode(catalog__('field_image', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_lock_version: <?= json_encode(catalog__('field_lock_version', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_version: <?= json_encode(catalog__('field_version', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_created_at: <?= json_encode(catalog__('field_created_at', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_updated_at: <?= json_encode(catalog__('field_updated_at', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_published_at: <?= json_encode(catalog__('field_published_at', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_active: <?= json_encode(catalog__('field_active', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_bundle: <?= json_encode(catalog__('field_bundle', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_meta_title: <?= json_encode(catalog__('field_meta_title', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_meta_description: <?= json_encode(catalog__('field_meta_description', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_canonical: <?= json_encode(catalog__('field_canonical', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_events: <?= json_encode(catalog__('field_events', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_weight: <?= json_encode(catalog__('field_weight', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_priority: <?= json_encode(catalog__('field_priority', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_match_field: <?= json_encode(catalog__('field_match_field', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_match_type: <?= json_encode(catalog__('field_match_type', $locale), JSON_UNESCAPED_UNICODE) ?>,
        field_source: <?= json_encode(catalog__('field_source', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_draft: <?= json_encode(catalog__('status_draft', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_pending_review: <?= json_encode(catalog__('status_pending_review', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_approved: <?= json_encode(catalog__('status_approved', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_published: <?= json_encode(catalog__('status_published', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_archived: <?= json_encode(catalog__('status_archived', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_pending: <?= json_encode(catalog__('status_pending', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_rejected: <?= json_encode(catalog__('status_rejected', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_ready: <?= json_encode(catalog__('status_ready', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_active: <?= json_encode(catalog__('status_active', $locale), JSON_UNESCAPED_UNICODE) ?>,
        status_inactive: <?= json_encode(catalog__('status_inactive', $locale), JSON_UNESCAPED_UNICODE) ?>,
        all_categories: <?= json_encode(catalog__('admin_all_categories', $locale), JSON_UNESCAPED_UNICODE) ?>,
        admin_all_industries: <?= json_encode(catalog__('admin_all_industries', $locale), JSON_UNESCAPED_UNICODE) ?>,
        admin_filter_industry: <?= json_encode(catalog__('admin_filter_industry', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_restaurant: <?= json_encode(catalog__('industry_restaurant', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_cafe: <?= json_encode(catalog__('industry_cafe', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_clothing: <?= json_encode(catalog__('industry_clothing', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_grocery: <?= json_encode(catalog__('industry_grocery', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_electronics: <?= json_encode(catalog__('industry_electronics', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_pharmacy: <?= json_encode(catalog__('industry_pharmacy', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_factory: <?= json_encode(catalog__('industry_factory', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_automotive: <?= json_encode(catalog__('industry_automotive', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_sports: <?= json_encode(catalog__('industry_sports', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_office: <?= json_encode(catalog__('industry_office', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_household: <?= json_encode(catalog__('industry_household', $locale), JSON_UNESCAPED_UNICODE) ?>,
        industry_retail_only: <?= json_encode(catalog__('industry_retail_only', $locale), JSON_UNESCAPED_UNICODE) ?>,
        attribute_schema: <?= json_encode(catalog__('admin_attribute_schema', $locale), JSON_UNESCAPED_UNICODE) ?>,
        details: <?= json_encode(catalog__('admin_details', $locale), JSON_UNESCAPED_UNICODE) ?>,
        yes: <?= json_encode(catalog__('admin_yes', $locale), JSON_UNESCAPED_UNICODE) ?>,
        no: <?= json_encode(catalog__('admin_no', $locale), JSON_UNESCAPED_UNICODE) ?>,
