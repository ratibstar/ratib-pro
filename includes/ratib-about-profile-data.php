...
if (!function_exists('ratib_about_profile_config')) {
    ...
    function ratib_about_profile_config(string $baseUrl): array
    {
        ...
        return [
            'meta' => [
                'title' => 'Ratib Company — Full company profile',
                'description' => 'Complete Ratib Company profile: legal identity, contact, mission, services, corridors, and enterprise platform capabilities.',
            ],
            'company' => [
                'trade_name' => 'Ratib Company',
                ...
                'industry' => 'Workforce program infrastructure · International recruitment operations',
                ...
                'vision' => 'Every cross-border workforce program runs on auditable infrastructure, not spreadsheets and disconnected CRMs.',
                'summary' => 'Ratib Company develops and operates RATIB: multi-tenant recruitment orchestration, workforce telemetry, compliance governance, and finance-grade billing for agencies and government-aligned programs.',
                'services' => [
