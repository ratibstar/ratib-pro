...
if (!function_exists('ratib_about_profile_config')) {
    ...
    function ratib_about_profile_config(string $baseUrl): array
    {
        ...
        return [
            ...
            'screenshots' => [
                'hero' => $shot('profile.image.hero', 'public/profile-media/about-ratib-command.png', 'profile.image.hero.alt', 'RATIB agency workspace — workforce records and SLA views'),
                'ops' => $shot('profile.image.ops', 'public/profile-media/about-ratib-command.png', 'profile.image.ops.alt', 'Agency operations workspace with workforce and agent views'),
                'workers' => $shot('profile.image.workers', 'public/profile-media/program-preview-workers.svg', 'profile.image.workers.alt', 'Worker records — lifecycle and documents'),
                'telemetry' => $shot('profile.image.telemetry', 'public/profile-media/government/tracking-map.png', 'profile.image.telemetry.alt', 'Operations map — field checkpoints and corridor context'),
                'accounting' => $shot('profile.image.accounting', 'public/profile-media/program-preview-finance.svg', 'profile.image.accounting.alt', 'Accounting and invoicing module'),
                'control' => $shot('profile.image.control', 'public/profile-media/government/government-control.png', 'profile.image.control.alt', 'Administration — multi-country agency settings'),
                'partners' => $shot('profile.image.partners', 'public/profile-media/about-ratib-command.png', 'profile.image.partners.alt', 'Partner portal — deployments and documents'),
                'pipeline' => $shot('profile.image.pipeline', 'public/profile-media/program-preview-pipeline.svg', 'profile.image.pipeline.alt', 'Workflow pipeline across recruitment stages'),
            ],
            'hero_metrics' => [
