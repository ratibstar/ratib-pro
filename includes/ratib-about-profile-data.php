...
if (!function_exists('ratib_about_profile_config')) {
    ...
    function ratib_about_profile_config(string $baseUrl): array
    {
        ...
        return [
            'meta' => [
                'title' => ratib_public_cms('profile.meta.title', 'RATEB — Recruitment Automation & Telemetry Enterprise Base'),
                'description' => ratib_public_cms('profile.meta.description', 'RATEB — enterprise workforce program infrastructure. Platform scope, corridors, and operational capabilities for cross-border recruitment programs.'),
            ],
            'platform' => [
                'eyebrow' => ratib_public_cms('profile.platform.eyebrow', 'Platform overview'),
                'title' => ratib_public_cms('profile.platform.title', 'RATEB dashboard'),
                'lead' => ratib_public_cms('profile.platform.lead', 'Recruitment orchestration, workforce tracking, compliance, and finance-grade operations for sending-country agencies and host-market programs—in one multi-tenant platform.'),
            ],
            'what' => [
            ...
            'sections' => [
                ...
                'tel' => [
                    ...
                    'title' => ratib_public_cms('profile.section.tel.title', 'GPS tracking'),
                    'sub' => ratib_public_cms('profile.section.tel.sub', 'Field tracking with offline sync, geofence rules, and audit-friendly event history—not a standalone tracking app.'),
                ],
                'gov' => [
            ...
            'company' => [
                ...
                'legal_name' => ratib_public_cms('profile.company.legal_name', 'RATEB Company'),
                ...
                'website' => ratib_public_cms('public.contact.website', 'https://rateb.sa'),
                'email' => ratib_public_cms('public.contact.email', 'info@rateb.sa'),
                ...
                'summary' => ratib_public_cms('profile.company.summary', 'RATEB Company operates the RATEB platform: a multi-agency workflow system with separate program databases, workforce tracking, policy controls, and integrated billing for agencies and oversight-aligned programs.'),
