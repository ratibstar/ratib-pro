 ...
 * Built from CMS keys (rateb_site_content) + canonical public URLs.
 *
 * @return list<array{keywords:list<string>,answer:string,category:string,synonyms?:list<string>}>
 */
declare(strict_types=1);

if (!function_exists('rateb_public_chat_kb_entries')) {
    function rateb_public_chat_kb_entries(string $baseUrl, array $home = []): array
    {
        $root = rtrim($baseUrl, '/');
        $homeUrl = function_exists('rateb_public_marketing_home_url')
