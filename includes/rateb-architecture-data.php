...
if (!function_exists('rateb_architecture_config')) {
    /**
     * @return array<string, mixed>
     */
    function rateb_architecture_config(string $baseUrl): array
    {
        ...
        return [
            'meta' => [
                'title' => rateb_public_cms('arch.meta.title', 'Platform Architecture — RATEB'),
                'description' => rateb_public_cms('arch.meta.description', 'Layered workforce program platform: shared core, tenant isolation, event delivery, field operations, finance module, and deployment topology for enterprise technical review.'),
            ],
            'hero' => [
                'eyebrow' => rateb_public_cms('arch.hero.eyebrow', 'Platform architecture'),
                'title' => rateb_public_cms('arch.hero.title', 'Multi-agency workforce program platform'),
                'lead' => rateb_public_cms('arch.hero.lead', 'RATEB is organized in platform layers that connect agency workspaces, partner portals, and regulated corridors—with separate agency databases, event-driven workflows, and policy controls in the stack.'),
            ...
            'overview' => [
                ...
                'eyebrow' => rateb_public_cms('arch.overview.eyebrow', 'Architecture overview'),
                'title' => rateb_public_cms('arch.overview.title', 'Orchestration infrastructure, not a single application'),
                'sub' => rateb_public_cms('arch.overview.sub', 'Programs, corridors, and agencies share a common workflow core while program data stays in separate agency databases. The platform separates user interfaces, workflow execution, field operations, finance, and storage.'),
                'points' => [
