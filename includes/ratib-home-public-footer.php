    ...
    <footer class="ratib-footer-enterprise" id="contact">
        <div class="ratib-container ratib-footer-enterprise__grid">
            ...
            <div class="ratib-footer-col">
                ...
                <ul class="ratib-footer-enterprise__link-list">
                    <li>
                        <a href="<?php echo htmlspecialchars(rtrim($baseUrl, '/') . '/profile', ENT_QUOTES, 'UTF-8'); ?>" class="ratib-nav__link ratib-footer-enterprise__nav-link ratib-footer-link--about" data-ratib-profile-nav="1"><?php echo $ratibGlyph('ratib-ng-solutions'); ?><span class="ratib-nav__label"><?php echo htmlspecialchars(trim((string) ($ratibHome['home.footer.link.company.about'] ?? '')) ?: 'Company profile', ENT_QUOTES, 'UTF-8'); ?></span></a>
                    </li>
                    <li>
