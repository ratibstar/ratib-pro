...
/**
 * Self-contained Global AI workflow (PDO only — no App\Core\Autoloader).
 *
 * @param array<string, mixed> $payload
 * @return array<string, mixed>
 */
function rateb_global_ai_workflow_core(array $payload): array
{
    ...
    $ctx = json_encode([
        ...
        'onboarding_source' => 'rateb_global_ai_workflow_core',
    ...
    $trackingOk = $tenantId > 0;
    return [
        'success' => true,
        'workflow_id' => (string) $workflowId,
        'worker_id' => $workerId,
        'tenant_id' => $trackingOk ? (string) $tenantId : '',
        'device_id' => $deviceId,
        'tracking_ok' => $trackingOk,
        'workflow_ok' => true,
        'tracking_message' => $trackingOk ? 'Tracking onboarding completed.' : 'Tracking not provisioned (tenant not resolved).',
        'workflow_message' => 'Worker onboarding workflow completed.',
        'handler' => 'global_ai_workflow_core',
        'build' => 'global-ai-v7',
    ];
}
