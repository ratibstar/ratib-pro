        ...
        $cfg = [
            ...
            'screenshots' => [
                [
                    ...
                    'label' => 'Illustrative interface',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.pipeline', 'assets/images/about-ratib-command.png'),
                    'alt' => ratib_public_cms('profile.image.pipeline.alt', 'Sample workforce pipeline board with stages and SLA column'),
                ],
                [
                    'title' => 'Operations dashboard',
                    'label' => 'Illustrative interface',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.ops', 'assets/images/about-ratib-command.png'),
                    'alt' => ratib_public_cms('profile.image.ops.alt', 'Sample agency operations dashboard with queues and summaries'),
                ],
                [
                    'title' => 'Finance ledger',
                    'label' => 'Illustrative interface',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.finance', 'assets/images/about-ratib-command.png'),
                    'alt' => ratib_public_cms('profile.image.accounting.alt', 'Sample ledger and invoicing screen'),
                ],
                [
                    'title' => 'Audit history',
                    'label' => 'Sample operational data',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.audit', 'assets/images/about-ratib-command.png'),
                ...
                [
                    ...
                    'label' => 'Sample operational data',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.map', 'assets/images/about-ratib-command.png'),
                    'alt' => ratib_public_cms('profile.image.telemetry.alt', 'Sample map view with checkpoints and corridor context'),
                ],
                [
                    'title' => 'Partner portal',
                    'label' => 'Illustrative interface',
                    'src' => ratib_public_cms_image($baseUrl, 'opproof.image.partner', 'assets/images/about-ratib-command.png'),
