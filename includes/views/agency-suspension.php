    ...
    <header class="header">
        ...
        <div class="header-center">
            <a href="<?php echo htmlspecialchars($siteBaseUrl . '/pages/home.php', ENT_QUOTES, 'UTF-8'); ?>" class="logo">
                <img src="<?php echo htmlspecialchars($siteBaseUrl . '/assets/ratib-logo.svg?v=6', ENT_QUOTES, 'UTF-8'); ?>" alt="RATEB — Rateb Software Foundation for Information Technology">
            </a>
