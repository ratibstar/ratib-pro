 ...
 */
function rateb_register_global_ai_html_patch(): void
{
    static $done = false;
    ...
    ob_start(static function (string $html): string {
        ...
        if (stripos($html, 'globalAiRunBtn') === false || stripos($html, 'rateb-global-ai-fetch-v7') !== false || stripos($html, 'ratebGlobalAiV7') !== false) {
            return $html;
        }
...
rateb_register_global_ai_html_patch();
