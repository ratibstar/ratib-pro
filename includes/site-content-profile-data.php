...
if (!function_exists('ratib_site_content_defaults_profile')) {
    ...
    function ratib_site_content_defaults_profile(): array
    {
        ...
        return [
            ...
            'profile.gov.image.control' => 'assets/images/government/government-control.png',
            'profile.gov.image.inspections' => 'assets/images/government/government-inspections.png',
            'profile.gov.image.tracking' => 'assets/images/government/tracking-map.png',
            'profile.gov.image.onboarding' => 'assets/images/government/worker-mobile-onboarding.png',
