...
if (!function_exists('rateb_security_compliance_config')) {
    /**
     * @return array<string, mixed>
     */
    function rateb_security_compliance_config(string $baseUrl): array
    {
        ...
        return [
            'meta' => [
                'title' => rateb_public_cms('trust.meta.title', 'Security & Compliance — RATEB Trust Center'),
                'description' => rateb_public_cms('trust.meta.description', 'RATEB security architecture, compliance governance, tenant isolation, and operational reliability — designed for regulated workforce program infrastructure and enterprise procurement review.'),
            ],
            'hero' => [
                'eyebrow' => rateb_public_cms('trust.hero.eyebrow', 'Trust center'),
                'title' => rateb_public_cms('trust.hero.title', 'Security & compliance for regulated workforce operations'),
                'lead' => rateb_public_cms('trust.hero.lead', 'RATEB is enterprise workforce program infrastructure designed for agencies and government-aligned programs that require auditable operations, tenant isolation, and procurement-ready governance — without overstating certifications.'),
                'chips' => [
            ...
            'disclaimer' => rateb_public_cms('trust.disclaimer', 'This trust center describes platform architecture and operational design. RATEB does not claim third-party certifications (such as SOC 2 or ISO) unless separately documented in a signed enterprise agreement.'),
            'sections' => [
                'security_overview' => [
