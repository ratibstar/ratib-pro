...
if (!function_exists('ratib_site_content_defaults_public_pages')) {
    ...
    function ratib_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.image.workers' => 'assets/images/program-preview-workers.svg',
            'profile.image.telemetry' => 'assets/images/government/tracking-map.png',
            'profile.image.accounting' => 'assets/images/program-preview-finance.svg',
            'profile.image.control' => 'assets/images/government/government-control.png',
            'profile.image.partners' => 'assets/images/about-ratib-command.png',
            'profile.image.pipeline' => 'assets/images/program-preview-pipeline.svg',
