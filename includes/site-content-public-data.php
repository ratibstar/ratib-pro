...
if (!function_exists('ratib_site_content_defaults_public_pages')) {
    ...
    function ratib_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.image.hero' => 'assets/images/about-ratib-command.png',
            'profile.image.ops' => 'assets/images/about-ratib-command.png',
            'profile.image.workers' => 'assets/images/about-ratib-command.png',
            'profile.image.telemetry' => 'assets/images/about-ratib-command.png',
            'profile.image.accounting' => 'assets/images/about-ratib-command.png',
            'profile.image.control' => 'assets/images/about-ratib-command.png',
            'profile.image.partners' => 'assets/images/about-ratib-command.png',
            'profile.image.pipeline' => 'assets/images/about-ratib-command.png',
            ...
            'opproof.image.pipeline' => 'assets/images/about-ratib-command.png',
            'opproof.image.ops' => 'assets/images/about-ratib-command.png',
            'opproof.image.finance' => 'assets/images/about-ratib-command.png',
            'opproof.image.audit' => 'assets/images/about-ratib-command.png',
            'opproof.image.map' => 'assets/images/about-ratib-command.png',
            'opproof.image.partner' => 'assets/images/about-ratib-command.png',
    ...
    function ratib_site_content_public_editor_groups(): array
    {
        ...
        $publicOnly = [
            [
                ...
                'intro' => 'Used on company profile and procurement pages. <strong>Homepage top bar phone</strong> is edited separately under <em>Homepage · Top bar</em> (<code>home.topbar.phone_display</code>).',
                'fields' => [
            ...
            [
                ...
                'intro' => 'Six cards under “Platform screens (sanitized)” on /profile.',
                'fields' => [
