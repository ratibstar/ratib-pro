...
if (!function_exists('rateb_site_content_defaults_public_pages')) {
    ...
    function rateb_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.platform.title' => 'RATEB dashboard',
            'profile.platform.lead' => 'Recruitment orchestration, workforce tracking, compliance, and finance-grade operations for sending-country agencies and host-market programs—in one multi-tenant platform.',
            ...
            'profile.opproof.sub' => 'Government oversight, workforce tracking, and mobile mobilization—then agency workspace, diagrams, and reference flows for procurement review.',
            ...
            'profile.section.tel.eyebrow' => 'Field tracking',
            'profile.section.tel.title' => 'GPS tracking',
            'profile.section.tel.sub' => 'Field tracking with offline sync, geofence rules, and audit-friendly event history—not a standalone tracking app.',
            ...
            'profile.image.telemetry.alt' => 'Tracking map — field checkpoints and corridor context',
            'profile.image.accounting.alt' => 'Accounting and invoicing module',
            'profile.image.control.alt' => 'Control panel — multi-country system settings',
            ...
            'arch.hero.lead' => 'RATEB is organized in platform layers that connect agency workspaces, partner portals, and regulated corridors—with separate agency databases, event-driven workflows, and system settings in the stack.',
