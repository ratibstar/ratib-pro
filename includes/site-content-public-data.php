...
if (!function_exists('ratib_site_content_defaults_public_pages')) {
    ...
    function ratib_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.platform.title' => 'RATEB operations control plane',
            'profile.platform.lead' => 'Recruitment orchestration, workforce telemetry, compliance, and finance-grade operations for sending-country agencies and host-market programs—in one multi-tenant control plane.',
            'profile.what.title' => 'What RATEB is — and what it is not',
            'profile.what.sub' => 'RATEB is enterprise workforce program infrastructure for regulated, high-volume international recruitment—not a lightweight CRM or worker tracker.',
            ...
            'profile.opproof.title' => 'How teams run programs on RATEB',
            'profile.opproof.sub' => 'Government oversight, workforce telemetry, and mobile mobilization—then agency workspace, diagrams, and reference flows for procurement review.',
            'profile.opproof.disclaimer' => 'Screenshots, diagrams, and metrics on this page use sample operational data or illustrative interfaces. They are not live production operations control planes, audited statistics, or evidence of universal government integrations.',
            ...
            'profile.section.tel.eyebrow' => 'Workforce telemetry',
            'profile.section.tel.title' => 'Geospatial workforce telemetry',
            'profile.section.tel.sub' => 'Operational telemetry with offline sync, geofence rules, and audit-friendly event history—not a standalone tracking app.',
            ...
            'profile.image.ops.alt' => 'Agency operations control plane with workforce and agent views',
            'profile.image.workers.alt' => 'Workforce system of record — lifecycle and documents',
            'profile.image.telemetry.alt' => 'Geospatial operations console — field checkpoints and corridor context',
            'profile.image.accounting.alt' => 'Accounting and invoicing module',
            'profile.image.control.alt' => 'Platform control plane — multi-country tenant policy configuration',
            ...
            'arch.meta.title' => 'Platform Architecture — RATEB',
            ...
            'arch.hero.lead' => 'RATEB is organized in platform layers that connect agency workspaces, partner portals, and regulated corridors—with separate agency databases, event-driven workflows, and tenant policy controls in the stack.',
            ...
            'trust.meta.title' => 'Security & Compliance — RATEB Trust Center',
            'trust.meta.description' => 'RATEB security architecture, compliance governance, tenant isolation, and operational reliability — designed for regulated workforce program infrastructure and enterprise procurement review.',
            'trust.hero.eyebrow' => 'Trust center',
            'trust.hero.title' => 'Security & compliance for regulated workforce operations',
            'trust.hero.lead' => 'RATEB is enterprise workforce program infrastructure designed for agencies and government-aligned programs that require auditable operations, tenant isolation, and procurement-ready governance — without overstating certifications.',
            'trust.disclaimer' => 'This trust center describes platform architecture and operational design. RATEB does not claim third-party certifications (such as SOC 2 or ISO) unless separately documented in a signed enterprise agreement.',

            'proc.meta.title' => 'Procurement & Legal — RATEB Enterprise',
    ...
    function ratib_site_content_public_editor_groups(): array
    {
        ...
        $publicOnly = [
            ...
            [
                ...
                'intro' => 'Upload PNG/WebP/SVG for each block. Use <strong>Save all</strong> after choosing files — no FTP needed.',
                'fields' => [
            ...
            [
                'id' => 'profile-diagrams',
                'title' => 'Company profile — reference diagrams',
                'intro' => 'SVG or PNG for the five diagram cards on /profile. Upload here to replace defaults.',
                'fields' => [
                    ['key' => 'profile.diagram.workflow', 'label' => 'Worker lifecycle workflow', 'type' => 'media_image'],
                    ['key' => 'profile.diagram.onboarding', 'label' => 'Agency onboarding', 'type' => 'media_image'],
                    ['key' => 'profile.diagram.deployment', 'label' => 'Deployment lifecycle', 'type' => 'media_image'],
                    ['key' => 'profile.diagram.tenant', 'label' => 'Tenant separation', 'type' => 'media_image'],
                    ['key' => 'profile.diagram.events', 'label' => 'Event processing', 'type' => 'media_image'],
                ],
            ],
            [
