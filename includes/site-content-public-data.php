...
if (!function_exists('ratib_site_content_defaults_public_pages')) {
    ...
    function ratib_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.image.hero' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.hero', 'public/profile-media/about-ratib-command.png') : 'public/profile-media/about-ratib-command.png',
            'profile.image.ops' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.ops', 'public/profile-media/about-ratib-command.png') : 'public/profile-media/about-ratib-command.png',
            'profile.image.workers' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.workers', 'public/profile-media/program-preview-workers.svg') : 'public/profile-media/program-preview-workers.svg',
            'profile.image.telemetry' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.telemetry', 'public/profile-media/government/tracking-map.png') : 'public/profile-media/government/tracking-map.png',
            'profile.image.accounting' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.accounting', 'public/profile-media/program-preview-finance.svg') : 'public/profile-media/program-preview-finance.svg',
            'profile.image.control' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.control', 'public/profile-media/government/government-control.png') : 'public/profile-media/government/government-control.png',
            'profile.image.partners' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.partners', 'public/profile-media/about-ratib-command.png') : 'public/profile-media/about-ratib-command.png',
            'profile.image.pipeline' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.pipeline', 'public/profile-media/program-preview-pipeline.svg') : 'public/profile-media/program-preview-pipeline.svg',
