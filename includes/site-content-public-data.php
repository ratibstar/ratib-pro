...
if (!function_exists('ratib_site_content_defaults_public_pages')) {
    ...
    function ratib_site_content_defaults_public_pages(): array
    {
        return [
            ...
            'profile.image.control' => function_exists('ratib_site_content_profile_media_default') ? ratib_site_content_profile_media_default('profile.image.control', 'public/cms-bundle-gov-control.png') : 'scmedia:cms-profile-image-control.png',
