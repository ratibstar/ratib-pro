    ...
    function ratib_site_content_public_editor_groups(): array
    {
        ...
        $publicOnly = [
            ...
            [
                ...
                'intro' => 'Optional overrides for the six cards below government on /profile. <strong>If left empty, each card reuses the matching workspace screenshot above</strong> (pipeline → pipeline, ops → ops, etc.).',
                'fields' => [
