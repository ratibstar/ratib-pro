 ...
 * https://rateb.sa/rateb-chrome-bust.php
 */
...
if (!is_string($live) || $live === '') {
    ...
    echo 'live_v13=' . (stripos($live, 'rateb-profile-nav=v13') !== false ? 'yes' : 'no') . "\n";
    echo 'live_onclick_profile=' . (stripos($live, 'onclick=') !== false && stripos($live, '/profile') !== false ? 'yes' : 'no') . "\n";
    echo 'live_go_profile=' . (stripos($live, 'data-rateb-go-profile') !== false ? 'yes' : 'no') . "\n";
...
echo "disk has_onclick=no → re-upload includes/rateb-home-public-chrome-top.php\n";
