...
final class DomainSearchRateLimiter
{
    ...
    public function allow(string $scopeKey, int $maxPerMinute = 30): bool
    {
        $stmt = $this->pdo->prepare(
            'INSERT INTO rateb_infra_domain_search_rate (scope_key, minute_bucket, request_count, created_at, updated_at)
        ...
        $check = $this->pdo->prepare(
            'SELECT request_count FROM rateb_infra_domain_search_rate
