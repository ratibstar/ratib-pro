-- =============================================================================
-- DO NOT RUN THIS FILE if rateb_infra_* should live ONLY on admin_control_panel_db
-- =============================================================================
-- Importing this recreates the same tables on admin_out — the opposite of “one DB only”.
-- Instead: run 007_drop_rateb_infra_from_admin_out.sql on admin_out (after backup).
--
-- Keep this file in the repo only as a historical reference or rare split-DB lab setups.
-- Canonical bundle: ALL_for_admin_control_panel_db.sql
