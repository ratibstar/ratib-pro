-- =============================================================================
-- DO NOT RUN THIS FILE if ratib_infra_* should live ONLY on outratib_control_panel_db
-- =============================================================================
-- Importing this recreates the same tables on outratib_out — the opposite of “one DB only”.
-- Instead: run 007_drop_ratib_infra_from_outratib_out.sql on outratib_out (after backup).
--
-- Keep this file in the repo only as a historical reference or rare split-DB lab setups.
-- Canonical bundle: ALL_for_outratib_control_panel_db.sql
