<?php
/**
 * EN: Handles API endpoint/business logic in `api/agents/bulk-deactivate.php`.
 * AR: يدير منطق واجهات API والعمليات الخلفية في `api/agents/bulk-deactivate.php`.
 */
...
try {
    ...
    if ($stmt->execute()) {
        ...
        throw new Exception('Failed to deactivate agents');
    }
