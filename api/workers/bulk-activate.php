<?php
/**
 * EN: Handles API endpoint/business logic in `api/workers/bulk-activate.php`.
 * AR: يدير منطق واجهات API والعمليات الخلفية في `api/workers/bulk-activate.php`.
 */
...
try {
    ...
    $sql = "UPDATE workers SET status = 'active' WHERE id IN ($placeholders)";
    
    error_log("BULK ACTIVATE - SQL: $sql");
    error_log("BULK ACTIVATE - IDs: " . implode(',', $workerIds));
    ...
    error_log("BULK ACTIVATE - Affected rows: $affectedRows");
    ...
    error_log("BULK ACTIVATE - Verification: " . json_encode($verifyResults));
    ...
    echo json_encode([
        'success' => true,
        'message' => "Activated $affectedRows workers",
