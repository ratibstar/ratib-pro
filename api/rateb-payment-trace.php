<?php
/**
 * EN: Handles API endpoint/business logic in `api/rateb-payment-trace.php`.
 * AR: يدير منطق واجهات API والعمليات الخلفية في `api/rateb-payment-trace.php`.
 */
 ...
 * Open in browser: /api/rateb-payment-trace.php (no secrets in response).
 */
...
$out['suggested_urls'] = [
    ...
    'this_trace' => $apiDir . '/rateb-payment-trace.php',
];
