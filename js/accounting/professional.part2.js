/**
 * EN: Implements frontend interaction behavior in `js/accounting/professional.part2.js`.
 * AR: ينفذ سلوك تفاعلات الواجهة الأمامية في `js/accounting/professional.part2.js`.
 */
/** Professional Accounting - Part 2 (lines 5199-10198) */
ProfessionalAccounting.prototype.formatDateForAPI = function(dateString) {
...
ProfessionalAccounting.prototype.loadModalInvoices = async function() {
...
ProfessionalAccounting.prototype.loadMainInvoices = async function() {
...
ProfessionalAccounting.prototype.loadModalBills = async function() {
...
ProfessionalAccounting.prototype.loadModalBankAccounts = async function() {
    ...
    /**
     * Helper function to check if an element and all its parents are visible and measurable
     * Returns true only if element can be properly measured (not hidden by display:none, etc.)
     */
...
ProfessionalAccounting.prototype.saveAccount = async function(accountId = null) {
        ...
        if (!accountId || accountId === 'null' || accountId === '' || accountId === 0) {
