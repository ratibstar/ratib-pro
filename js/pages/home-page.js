    ...
    function run() {
        ...
        pillWrap.querySelectorAll('a.ratib-nav__link').forEach(function (a) {
            ...
            if (hp === '#platform' && !a.classList.contains('ratib-nav__link--product-tour')) {
                ...
                key = 'contact';
            } else if (/profile\.php/i.test(href) || /about\.php/i.test(href) || /[?&]open=(about|profile)\b/i.test(href) || a.classList.contains('ratib-nav__link--about')) {
                key = 'about';
...
(function ratibAboutNavInject() {
    ...
    function inject() {
        ...
        var a = document.createElement('a');
        a.href = home.replace(/\/home\.php.*$/, '/profile.php').replace(/[#?].*$/, '') || '/pages/profile.php';
        a.className =
