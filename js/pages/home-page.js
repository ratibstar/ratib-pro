...
(function () {
    ...
    function updatePaymentSummary(subtotal, years, planKeyOpt) {
        ...
        if (displayCur !== gatewayCur) {
            ngeniusNote = '<p class="small mb-0 mt-2 ratib-ngenius-currency-note">Approximate in ' + displayCur + ': <strong class="ratib-ngenius-sar-total">' + displayCur + ' ' + displayApprox + '</strong> <span class="ratib-ngenius-rate-note">(USD × ' + displayRateStr + ')</span>.</p>';
        } else {
            ngeniusNote = '<p class="small mb-0 mt-2 ratib-ngenius-currency-note">Approximate total: <strong class="ratib-ngenius-sar-total">' + gatewayCur + ' ' + gatewayApprox + '</strong> <span class="ratib-ngenius-rate-note">(USD × ' + gatewayRateStr + ')</span>.</p>';
        }
