...
(function () {
    ...
    /* Nav IA v3 — keep in sync with js/pages/ratib-public-nav-ia-fix.js */
    (function ratibPublicNavIaFixFromHomePage() {
        if (window.__ratibNavIaFixLoaded) {
            return;
        }
        window.__ratibNavIaFixLoaded = true;
        if (document.body && document.body.getAttribute('data-ratib-about') === '1') {
            return;
        }
        var PROFILE =
    ...
    function ratibStripDuplicateNavBrandLogo() {
        document.querySelectorAll('a.ratib-nav__brand').forEach(function (brand) {
    ...
    ratibStripDuplicateNavBrandLogo();
    document.addEventListener('DOMContentLoaded', ratibStripDuplicateNavBrandLogo);
    setTimeout(ratibStripDuplicateNavBrandLogo, 0);
    setTimeout(ratibStripDuplicateNavBrandLogo, 400);
...
(function ratibHomeEnsureProductTourNavTab() {
    ...
    function run() {
        ...
        if (!nav.querySelector('.ratib-nav__platform-links')) {
            return;
        }
...
/* Legacy nav pill row: handled by js/pages/ratib-public-nav-ia-fix.js (IA v3). */
    ...
    function initProgramStripMarqueeAndLightbox() {
        ...
        if (window.RatibGalleryLightbox && typeof window.RatibGalleryLightbox.init === 'function') {
            window.RatibGalleryLightbox.init({
                marqueeClickGuard: true,
                collectExtraSlides: function () {
                    ...
                    return Array.prototype.slice.call(allProgOpen, 0, halfCount > 0 ? halfCount : total);
                }
            });
        }
    }
