/**
 * EN: Implements frontend interaction behavior in `js/login.js`.
 * AR: ينفذ سلوك تفاعلات الواجهة الأمامية في `js/login.js`.
 */
/**
    ...
    async function autoAuthenticateFingerprint() {
        ...
        try {
            ...
            if (!startData.publicKey) {
                showFingerprintStatus(`❌ ${startData.message || 'No fingerprint registered. Please register in System Settings first.'}`, 'error');
                if (spinner) {
            ...
            if (error.name === 'NotAllowedError') {
                ...
                errorMessage = 'No fingerprint registered. Please register in System Settings first.';
