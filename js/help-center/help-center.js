...
const HELP_CENTER_BUILTIN = window.HELP_CENTER_BUILTIN || {
    1: [{ id: 'builtin-1-0', title: 'Getting Started', overview: 'Introduction to the RATEB program.', content: '<p>Use the left menu: Dashboard, Agent, SubAgent, Workers, Cases, Accounting, HR, Reports, Contact, Notifications. Bookmark the Help Center.</p>', estimated_time: 5, difficulty_level: 'beginner', views_count: 0 }],
