...
window.HELP_CENTER_BUILTIN = {
    1: [
        ...
        },
        {
            ...
            '<h2>Step 2: Understanding Your First Screen (Operations Control Plane)</h2>' +
            ...
            '<p>On the left side of your screen, you will see a vertical menu with icons and text. This is your main navigation. Menu items you may see include: Operations Control Plane (takes you to the main overview page), Agent (manage your agents), SubAgent (manage your subagents), Workers (manage worker profiles and documents), 🌍 Partner Agencies (manage overseas partner offices and open <strong>View</strong> for workers sent / deployment rows), Cases (track and manage cases), Accounting (financial management and transactions), HR (human resources management), Executive Telemetry (view and generate reports), Contact (manage contacts), Communications (view messages and communications), Operational Signaling (see system alerts), Tenant Policy Configuration (system configuration, Admin only), Profile (your user profile), Logout (sign out of the system).</p>' +
        ...
        },
        {
            ...
            '<h2>Contact Menu Item</h2><p><strong>What it is</strong> – Contact management: people you communicate with (not agents or workers, but other contacts).<br><strong>When to use</strong> – Add a contact, edit contact details, view contact list, link contacts to communications.<br><strong>What you see</strong> – Table of contacts (columns: name, email, phone, company, type, status), search box, filters (by type, by status), Add Contact button, View/Edit/Delete per row.<br><strong>Buttons and actions</strong> – <strong>Add Contact</strong> opens form (name, email, phone, company, address, type, status, notes). <strong>Search</strong> finds by name, email, phone. <strong>Filter</strong> by type or status. <strong>Edit</strong> updates contact details. <strong>Delete</strong> removes contact.<br><strong>How it connects</strong> – Contacts link to Communications (each communication links to a contact), Executive Telemetry (contact activity reports).</p>' +
    ...
    2: [
        {
            ...
            '<h2>Understanding Operations Control Plane Cards – Complete Breakdown</h2>' +
            ...
            '<h2>How to Use Operations Control Plane Cards</h2>' +
            ...
            '<h2>Understanding Each Operations Control Plane Card</h2>' +
            '<h3>Agents Card</h3>' +
            ...
            '<p>Some Operations control planes may show charts:</p>' +
            ...
            '<li>Check operations control plane daily to monitor system activity.</li>' +
            '<li>Click stat cards to navigate quickly to modules.</li>' +
            '<li>Review recent activities to stay aware of what\'s happening.</li>' +
            '<li>Use the Operations Control Plane as your starting point for your daily work.</li></ul>',
            estimated_time: 25,
            difficulty_level: 'beginner',
            views_count: 0,
            updated_at: '2026-02-10'
        },
        {
            ...
            overview: 'Extremely detailed, step-by-step instructions for navigating the Operations Control Plane: identifying menu items, understanding cards, opening modules, and returning to the Operations Control Plane.',
            content:
            ...
            '<h3>Step 8: To Return to the Operations Control Plane</h3>' +
            '<p>To return to the Operations Control Plane: Click <strong>"Operations Control Plane"</strong> in the left menu. OR click the Operations Control Plane card. OR click the logo/company name at the top left.</p>' +
            '<h2>Expert Tips</h2>' +
            '<ul><li>Use operations control plane cards for quick navigation.</li><li>Check statistics regularly to monitor system activity.</li><li>Click cards instead of menu items for faster access.</li></ul>',
            estimated_time: 10,
            difficulty_level: 'beginner',
            views_count: 0,
            updated_at: '2026-02-10'
        },
        {
            ...
            '<h3>Reports / Activity</h3><p>May show <strong>total</strong> activity or log entries, <strong>today</strong> count, and <strong>this month</strong> count. These reflect system usage and history. Use the <strong>Executive Telemetry</strong> section for real report types (agent, worker, financial, etc.).</p>' +
            ...
            '<h3>Operational Signaling</h3><p><strong>New / Total</strong> – Unread and total notifications. Click to open <strong>Operational Signaling</strong> and read or act on alerts.</p>' +
    ...
    3: [
        {
            ...
            overview: 'Tenant Policy Configuration, users, roles, and every permission explained so you can set up and manage access correctly.',
            content:
            '<h2>Where User Management Lives</h2><p>All user and permission management is under <strong>Tenant Policy Configuration</strong> in the left menu. Only users with admin or equivalent permission can open it. If you do not see Tenant Policy Configuration, your role does not have access.</p>' +
        ...
        },
        {
            ...
            content: '<h2>Key Points</h2><ul><li>Each user has a role (e.g. Admin, Manager).</li><li>Roles define what menus and actions are visible.</li><li>User and role management is in Tenant Policy Configuration (admin only).</li><li>If you cannot see a section, your role may not have the permission—contact your administrator.</li></ul><h2>Expert Tip</h2><p>Give each role only the permissions it needs for the job.</p>',
            estimated_time: 5,
            difficulty_level: 'beginner',
            views_count: 0
        }
    ...
    5: [
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, locate the <strong>Agents card</strong>. OR click <strong>"Agent"</strong> in the left sidebar menu (👥 icon).</p>' +
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"SubAgent"</strong> in left menu (👤 icon). OR click SubAgents card on the operations control plane.</p>' +
    ...
    7: [
        {
            ...
            '<h2>Viewing Balances and Reports</h2><p>Use the account list or trial balance to see balances. Use <strong>Executive Telemetry</strong> for profit/loss and other financial reports by period or category. Export data for backup or external reporting if the system allows.</p>' +
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"Accounting"</strong> in left menu (💰 icon). OR click Accounting card.</p>' +
            '<h3>Step 2: Page Loads</h3>' +
            '<p>Accounting page loads. You will see <strong>tabs</strong> at the top: Control Panel (Operations Control Plane), Chart of Accounts, Journal Entries, Invoices, Bills, Banking &amp; Cash, Financial Reports, And more...</p>' +
        ...
        },
        {
            ...
            '<h3>1. Control Panel (Operations Control Plane)</h3>' +
    ...
    8: [
        {
            ...
            content: '<h2>What Reports Are For</h2><p>The <strong>Executive Telemetry</strong> section lets you generate reports and analytics from agents, workers, cases, accounting, HR, and other data. Use it to monitor performance, prepare for management, and meet compliance or audit needs.</p>' +
            '<h2>Opening Reports</h2><p>Click <strong>Executive Telemetry</strong> in the left menu. You may see categories (e.g. Agents, HR, Financial) or a list of report types. Your menu may also show <strong>Individual Reports</strong> or <strong>Financial Reports</strong> under Accounting.</p>' +
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"Reports"</strong> in left menu (📊 icon).</p>' +
            '<h3>Step 2: Page Loads</h3>' +
    ...
    9: [
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"HR"</strong> in left menu (👔 icon).</p>' +
            '<h3>Step 2: Page Loads</h3>' +
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"Cases"</strong> in left menu (📋 icon).</p>' +
            '<h3>Step 2: Page Loads</h3>' +
        ...
        },
        {
            ...
            '<h3>Step 1: From the Operations Control Plane</h3>' +
            '<p>From the Operations Control Plane, <strong>Click</strong> <strong>"Contact"</strong> in left menu (📞 icon).</p>' +
            '<h3>Step 2: Page Loads</h3>' +
    ...
    12: [
        ...
        },
        {
            ...
            '<ul><li><strong>Categories sidebar</strong> – List of categories on the left side (Getting Started, Operations Control Plane, User Management, Contracts &amp; Recruitment, Client Management, Worker Management, 🌍 Partner Agencies, Finance &amp; Billing, Reports &amp; Analytics, Notifications &amp; Automation, Troubleshooting &amp; FAQ, Best Practices, Compliance &amp; Legal).</li>' +
            ...
            '<li><strong>Executive Telemetry</strong> – Generating reports, export options, report types.</li>' +
        ...
        },
        {
            ...
            '<p>Look at <strong>Categories</strong> list on left side: Getting Started, Operations Control Plane, User Management, Worker Management, Accounting, HR Management, And more...</p>' +
