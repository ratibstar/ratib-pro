<?php
/**
 * One-shot production migration: Phase 5 integrity tables
 *
 * Auth: header X-Rateb-Migrate-Token
 * Usage: curl -H "X-Rateb-Migrate-Token: YOUR_TOKEN" https://rateb.sa/public/run-accounting-phase5-migrate.php
 */
...
$sqlFile = dirname(__DIR__) . '/config/migrations/20260704_accounting_phase5_integrity.sql';
if (!is_file($sqlFile)) {
...
foreach (['accounting_reconciliation_reports', 'accounting_correction_log', 'accounting_audit_evidence_packs'] as $t) {
