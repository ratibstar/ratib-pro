<?php
/**
 * One-shot production migration: Phase 4 projection / consolidation / drift tables
 *
 * Auth: header X-Rateb-Migrate-Token (same token as rateb-erp/public/run-migrations.php)
 * Usage: curl -H "X-Rateb-Migrate-Token: YOUR_TOKEN" https://rateb.sa/public/run-accounting-phase4-migrate.php
 */
...
$sqlFile = dirname(__DIR__) . '/config/migrations/20260704_accounting_phase4_projections.sql';
if (!is_file($sqlFile)) {
