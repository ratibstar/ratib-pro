...
<div class="table-card">
    ...
    <div class="control-settings-intro">
        <strong>Control Panel Users</strong> — Table: <code>control_admins</code>. Users who can log into the control panel only. <strong>Not</strong> main platform users. For country-level platform users, use <a href="<?php echo pageUrl('control/country-users.php'); ?>?control=1" class="text-decoration-none">Country Users</a>.
    </div>
