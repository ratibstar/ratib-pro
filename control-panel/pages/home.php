...
<p>Client Hub plans and service onboarding live in the main RATIB platform experience. Set <code>SITE_URL</code> so this page can redirect into the unified customer flow automatically.</p>
</body></html>
