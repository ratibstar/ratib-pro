 ...
 * Full system settings (users, visa types, etc.) are in the main platform app; this page links there.
 */
...
$platformDashboardUrl = $platformRoot !== '' ? ($platformRoot . '/pages/dashboard.php') : '#';
?>
<div class="p-4">
    <div class="alert alert-info">
        <h5><i class="fas fa-info-circle me-2"></i>System settings (users, visa types, recruitment)</h5>
        <p class="mb-0">To manage users, visa types, and other program settings for <strong><?php echo htmlspecialchars($agencyName); ?></strong>, open the main platform with the selected agency.</p>
