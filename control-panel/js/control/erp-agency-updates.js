(function () {
    ...
    function run(payload, confirmMsg) {
        ...
        setBusy(true);
        showProgress('Running ERP migrations…');
        ...
        fetch(apiUrl, {
            ...
            .then(function (pack) {
                ...
                showProgress(data.success ? 'Completed successfully.' : 'Completed with errors — see log.');
            })
            .catch(function (err) {
                showProgress('Request failed: ' + (err && err.message ? err.message : 'unknown'));
            })
            .finally(function () {
                setBusy(false);
                refreshSelectedBtn();
