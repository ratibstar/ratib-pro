                    ...
                    <td class="action-btns ag-actions-cell">
                        ...
                        <div class="dropdown ag-actions-dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-dark ag-actions-menu dropdown-menu-end">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><button type="button" class="dropdown-item btn-provision-pro" data-agency-id="<?php echo $agencyIdRow; ?>" data-permission="control_agencies,edit_control_agency" onclick="return window.RatibCpAgencies &amp;&amp; window.RatibCpAgencies.provisionProClick(this, event);"><i class="fas fa-server ag-menu-ico ag-ico-pro"></i><?php echo htmlspecialchars($agT('agencies.provision_pro', 'Provision Pro'), ENT_QUOTES, 'UTF-8'); ?></button></li>
                                <li><button type="button" class="dropdown-item btn-provision-erp" data-agency-id="<?php echo $agencyIdRow; ?>" data-erp-plan="<?php echo htmlspecialchars((string) ($r['erp_plan_slug'] ?? 'professional'), ENT_QUOTES, 'UTF-8'); ?>" data-erp-status="<?php echo htmlspecialchars($erpStBtn, ENT_QUOTES, 'UTF-8'); ?>" data-permission="control_agencies,edit_control_agency" onclick="return window.RatibCpAgencies &amp;&amp; window.RatibCpAgencies.provisionErpClick(this, event);"><i class="fas fa-cogs ag-menu-ico ag-ico-erp"></i><?php echo htmlspecialchars($erpProvisionLabel, ENT_QUOTES, 'UTF-8'); ?></button></li>
                                <li><hr class="dropdown-divider"></li>
