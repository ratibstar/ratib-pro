...
?>"><?php echo $isSuspended ? 'Suspended' : ($isActive ? 'Active' : 'Inactive'); ?></span></td>
                    ...
                    <td class="action-btns ag-actions-cell">
                        ...
                        <div class="dropdown ag-actions-dropdown">
                            <button type="button" class="ag-btn ag-btn-actions dropdown-toggle ag-actions-toggle" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" aria-haspopup="true">
