...
<aside class="control-sidebar" id="control-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo htmlspecialchars(function_exists('control_rateb_erp_branch_manage_url') ? control_rateb_erp_branch_manage_url(0) : control_rateb_erp_branches_hub_page_url(), ENT_QUOTES, 'UTF-8'); ?>" class="sidebar-subitem<?php echo (basename($_SERVER['PHP_SELF'] ?? '') === 'rateb-erp-branches.php') ? ' active' : ''; ?>" data-permission="control_dashboard"><i class="fas fa-store"></i><span><?php echo htmlspecialchars($cpT('nav.erp_branch_links'), ENT_QUOTES, 'UTF-8'); ?></span></a></li>
            <?php
