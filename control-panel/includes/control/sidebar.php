...
<aside class="control-sidebar" id="control-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo pageUrl('control/infrastructure.php'); ?>?control=1&amp;view=control" class="sidebar-item <?php echo (basename($_SERVER['PHP_SELF']) === 'infrastructure.php' && (($_GET['view'] ?? 'control') === 'control')) ? 'active' : ''; ?>" data-permission="control_system_settings,view_control_system_settings"><i class="fas fa-sliders-h"></i><span>Infrastructure Control</span></a></li>
            <li><a href="<?php echo pageUrl('control/infrastructure.php'); ?>?control=1&amp;view=dashboard" class="sidebar-item <?php echo (basename($_SERVER['PHP_SELF']) === 'infrastructure.php' && (($_GET['view'] ?? '') === 'dashboard')) ? 'active' : ''; ?>" data-permission="control_system_settings,view_control_system_settings"><i class="fas fa-chart-line"></i><span>Infrastructure Dashboard</span></a></li>
            <li><a href="<?php echo pageUrl('control/infrastructure.php'); ?>?control=1&amp;view=providers" class="sidebar-item <?php echo (basename($_SERVER['PHP_SELF']) === 'infrastructure.php' && (($_GET['view'] ?? '') === 'providers')) ? 'active' : ''; ?>" data-permission="control_system_settings,view_control_system_settings"><i class="fas fa-plug"></i><span>Infrastructure Providers</span></a></li>
