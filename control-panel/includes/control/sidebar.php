...
<aside class="control-sidebar" id="control-sidebar">
    ...
    <nav class="sidebar-nav">
        <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo htmlspecialchars(control_panel_page_with_control('control/tenant-rollout.php')); ?>" class="sidebar-item <?php echo (basename($_SERVER['PHP_SELF']) === 'tenant-rollout.php') ? 'active' : ''; ?>" data-permission="control_system_settings,view_control_system_settings,control_dashboard"><i class="fas fa-diagram-project"></i><span>Tenants &amp; Rollout</span></a></li>
