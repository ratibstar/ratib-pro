...
final class UpdateCartLineUseCase
{
    ...
    public function execute(PosV2RequestContext $context, string $lineId, UpdateLineRequest $request): CartResponse
    {
        $this->access->assertCanModify($context);

        return $this->cart->updateLine(
