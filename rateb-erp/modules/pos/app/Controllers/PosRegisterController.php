...
final class PosRegisterController extends PosBaseController
{
    ...
    private function resolveCapabilities(): array
    {
        ...
        return [
            ...
            // Rail stays inside POS — no ERP inventory / purchase-invoice deep links.
            'nav' => [
                'sales' => $can('pos.register'),
                'customers' => $can('pos.register'),
                'products' => $can('pos.register'),
                'inventory' => $can('pos.inventory.adjust'),
                'purchases' => $can('pos.orders.view'),
                'reports' => $can('pos.reports.view'),
                'settings' => $can('pos.settings.manage'),
            ],
        ];
    ...
    private function registerI18n(): array
    {
        $keys = [
            ...
            'pos_clear_cart', 'pos_clear_all', 'pos_hold', 'pos_cancel_order', 'pos_new_sale', 'pos_remove_line', 'pos_increase_qty', 'pos_decrease_qty',
            ...
            'pos_supervisor_approval_required', 'pos_supervisor_offline_hint', 'pos_supervisor_offline_confirm',
            'pos_supervisor_offline_blocked', 'pos_supervisor_scan_hint',
            'pos_biometric_gate', 'pos_biometric_scan_fingerprint',
