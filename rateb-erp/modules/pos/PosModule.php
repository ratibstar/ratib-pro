...
/**
 * Enterprise POS module bootstrap — isolated under modules/pos/.
 * Registers autoload, i18n, and entity-permission merge hooks.
 */
final class PosModule
{
    private const ROOT_REL = '/modules/pos';
