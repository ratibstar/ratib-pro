...
/**
 * Phase 23B — Enterprise Human Resources Offline test runner.
 *
...
require_once __DIR__ . '/HumanResourcesOfflinePhase23bTest.php';

$results = (new HumanResourcesOfflinePhase23bTest())->run();
