...
/**
 * Phase 21B — Enterprise Procurement Offline test runner.
 *
...
require_once __DIR__ . '/ProcurementEnterpriseOfflinePhase21bTest.php';

$results = (new ProcurementEnterpriseOfflinePhase21bTest())->run();
