...
/**
 * Phase 6 — Offline Monitoring test runner.
 *
 * php offline/tests/run-offline-monitoring-tests.php
 */
...
require_once __DIR__ . '/OfflineMonitoringPhase6Test.php';

$results = (new OfflineMonitoringPhase6Test())->run();
