...
final class ErpOfflineMasterDataPhase13Test
{
    ...
    private function testSdkExposesMasterData(): void
    {
        ...
        $ok = str_contains($sdk, 'isMasterDataEnabled')
            && (str_contains($sdk, '13.0.0') || str_contains($sdk, '13.1.0') || str_contains($sdk, '14.0.0') || str_contains($sdk, '14.2.0'))
            && str_contains($sdk, 'masterData:')
            && str_contains($bundle, 'RatebOfflineMasterData')
            && (str_contains($bundle, '13.0.0') || str_contains($bundle, '13.1.0') || str_contains($bundle, '14.0.0') || str_contains($bundle, '14.2.0'));
