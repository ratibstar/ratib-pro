...
return [
    ...
    'documents_document_create' => [
        ...
        'method' => 'POST',
        'path' => '/api/v1/offline/queue',
        'replay' => 'delegate_documents',
    ],
    'documents_repository_create' => [
        'module' => 'documents',
        'method' => 'POST',
        'path' => '/api/v1/offline/queue',
        'replay' => 'delegate_documents',
    ],
    'documents_workflow_transition' => [
        'module' => 'documents',
        'method' => 'POST',
        'path' => '/api/v1/offline/queue',
        'replay' => 'delegate_documents',
    ...
    'documents_repository_directory' => [
        'module' => 'documents',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/documents_repository_directory',
        'replay' => 'delta_pull',
    ],
    'documents_category_directory' => [
        'module' => 'documents',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/documents_category_directory',
        'replay' => 'delta_pull',
    ],
    'documents_workflow_status_directory' => [
        'module' => 'documents',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/documents_workflow_status_directory',
        'replay' => 'delta_pull',
    ],
    'bi_dashboard_create' => [
        'module' => 'bi',
    ...
    'bi_dashboard_directory' => [
        'module' => 'bi',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/bi_dashboard_directory',
        'replay' => 'delta_pull',
    ],
    'bi_kpi_directory' => [
        'module' => 'bi',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/bi_kpi_directory',
        'replay' => 'delta_pull',
    ],
    'bi_workflow_status_directory' => [
        'module' => 'bi',
        'method' => 'GET',
        'path' => '/api/v1/offline/delta/bi_workflow_status_directory',
        'replay' => 'delta_pull',
    ],
];
