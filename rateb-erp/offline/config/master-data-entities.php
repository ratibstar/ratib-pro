...
return [
    'entities' => [
        ...
        /** Phase 20B — optional Approval directories (read-only; flag offline.approval.masterdata). */
        'approval_template_directory' => [
            'table' => 'rateb_eap_templates',
            'aliases' => ['approval_templates'],
            'cache_prefix' => 'atpl',
            'branch_scoped' => true,
            'requires_updated_at' => true,
        ],
        ...
        'approval_delegation_directory' => [
            ...
            'aliases' => ['approval_delegations'],
            'cache_prefix' => 'adel',
            'branch_scoped' => true,
            'requires_updated_at' => true,
        ],
        'approval_status_directory' => [
            'table' => null,
            'aliases' => ['approval_statuses'],
            'cache_prefix' => 'asts2',
            'branch_scoped' => false,
            'requires_updated_at' => false,
            'static_catalog' => true,
