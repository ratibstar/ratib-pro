...
/**
 * Phase 18B — read-only Projects master-data deltas + static catalogs.
 * Gated by offline.projects.masterdata (requires offline.enabled + offline.projects).
 */
final class ProjectOfflineMasterDataDirectoryService
{
    ...
    private const ENTITIES = [
        ...
        'project_type_directory' => ['static' => true],
        'milestone_type_directory' => ['static' => true],
        'task_status_directory' => ['static' => true],
        'issue_type_directory' => ['static' => true],
        'risk_level_directory' => ['static' => true],
    ];
    ...
    public function pull(
        ...
        if (!$this->flags()->isProjectsMasterDataEnabled()) {
            return [
                'entity_type' => $entity,
                'items' => [],
    ...
    private function pullStatic(string $entity): array
    {
        $items = match ($entity) {
            'project_type_directory' => [
                ['id' => 1, 'code' => 'general', 'name' => 'General', 'active' => true],
                ['id' => 2, 'code' => 'client', 'name' => 'Client', 'active' => true],
                ['id' => 3, 'code' => 'internal', 'name' => 'Internal', 'active' => true],
            ],
            'milestone_type_directory' => [
                ['id' => 1, 'code' => 'delivery', 'name' => 'Delivery', 'active' => true],
                ['id' => 2, 'code' => 'review', 'name' => 'Review', 'active' => true],
                ['id' => 3, 'code' => 'gate', 'name' => 'Gate', 'active' => true],
            ],
            'task_status_directory' => (static function (): array {
                $out = [];
                foreach (ProjectWorkflowService::taskStatuses() as $i => $code) {
                    $out[] = [
                        'id' => $i + 1,
                        'code' => $code,
                        'name' => $code,
            ...
            'issue_type_directory' => [
                ['id' => 1, 'code' => 'bug', 'name' => 'Bug', 'active' => true],
                ['id' => 2, 'code' => 'blocker', 'name' => 'Blocker', 'active' => true],
                ['id' => 3, 'code' => 'improvement', 'name' => 'Improvement', 'active' => true],
            ],
            'risk_level_directory' => [
                ['id' => 1, 'code' => 'low', 'name' => 'Low', 'active' => true],
                ['id' => 2, 'code' => 'medium', 'name' => 'Medium', 'active' => true],
                ['id' => 3, 'code' => 'high', 'name' => 'High', 'active' => true],
            ],
            default => [],
        };
