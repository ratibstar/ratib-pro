...
<td><?php echo Rateb\App\Core\View::escape($row['mime_type']); ?></td>
<td><?php echo (int) $row['file_size']; ?></td>
<td><input type="text" class="form-control form-control-sm" readonly value="<?php echo Rateb\App\Core\View::escape($row['public_url'] ?? ''); ?>" onclick="this.select()"></td>
</tr>
<?php } ?>
</tbody></table></div></div>
