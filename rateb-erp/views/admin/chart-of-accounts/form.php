            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="f_<?php echo Rateb\App\Core\View::escape($name); ?>" name="<?php echo Rateb\App\Core\View::escape($name); ?>">
                        ...
                        <option value="<?php echo Rateb\App\Core\View::escape($opt); ?>"<?php echo (string) $value === (string) $opt ? ' selected' : ''; ?>><?php echo Rateb\App\Core\View::escape($opt === '1' || $opt === '0' ? __($opt === '1' ? 'active' : 'inactive') : __($opt)); ?></option>
                        <?php } ?>
                    </select>
                    <?php } else { ?>
