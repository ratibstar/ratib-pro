<?php declare(strict_types=1); /** @var array<string,mixed> $item */ /** @var list<array<string,mixed>> $widgets */ /** @var list<array<string,mixed>> $timeline */ /** @var list<string> $transitions */ /** @var bool $canTransition */ ?>
...
<form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('bi/dashboards').'/'.(int)($item['id']??0).'/transition'), ENT_QUOTES,'UTF-8'); ?>" class="row g-2 align-items-end"><?php echo rateb_csrf_field(); ?>
...
<h2 class="h5"><?php echo htmlspecialchars(__('bi_widgets'), ENT_QUOTES,'UTF-8'); ?></h2>
<ul class="list-group mb-4"><?php foreach(($widgets??[]) as $w): ?><li class="list-group-item"><?php echo htmlspecialchars((string)($w['title']??''), ENT_QUOTES,'UTF-8'); ?> (<?php echo htmlspecialchars((string)($w['widget_type']??''), ENT_QUOTES,'UTF-8'); ?>)</li><?php endforeach; ?><?php if(($widgets??[])===[]): ?><li class="list-group-item text-muted"><?php echo htmlspecialchars(__('no_records'), ENT_QUOTES,'UTF-8'); ?></li><?php endif; ?></ul>
</div>
