...
<form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('bi/reports').'/'.(int)($item['id']??0).'/transition'), ENT_QUOTES,'UTF-8'); ?>" class="row g-2"><?php echo rateb_csrf_field(); ?>
