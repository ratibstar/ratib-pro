...
<div class="container-fluid py-3">
    ...
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('accounting/tax-codes')), ENT_QUOTES, 'UTF-8'); ?>" class="row g-3 col-lg-6">
        ...
        <div class="col-md-4"><label class="form-label"><?php echo htmlspecialchars(__('rate_percent'), ENT_QUOTES, 'UTF-8'); ?></label><input class="form-control" type="number" step="0.0001" name="rate_percent" value="15"></div>
        <div class="col-md-4"><label class="form-label"><?php echo htmlspecialchars(__('type'), ENT_QUOTES, 'UTF-8'); ?></label>
            <select class="form-select" name="tax_type">
                <option value="vat"><?php echo htmlspecialchars(__('tax_type_vat'), ENT_QUOTES, 'UTF-8'); ?></option>
                <option value="withholding"><?php echo htmlspecialchars(__('tax_type_withholding'), ENT_QUOTES, 'UTF-8'); ?></option>
                <option value="other"><?php echo htmlspecialchars(__('tax_type_other'), ENT_QUOTES, 'UTF-8'); ?></option>
            </select>
        </div>
