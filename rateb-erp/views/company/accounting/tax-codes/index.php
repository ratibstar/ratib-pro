...
<div class="container-fluid py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <?php if ($canCreate): ?>
        <a class="btn btn-primary btn-sm" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('accounting/tax-codes/create')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('accounting_tax_code_create'), ENT_QUOTES, 'UTF-8'); ?></a>
        <?php endif; ?>
    </div>
