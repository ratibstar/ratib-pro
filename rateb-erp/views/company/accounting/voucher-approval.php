...
<div class="rateb-entry-approval">
    <div class="rateb-entry-approval-head d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
        <h5 class="mb-0"><i class="fas fa-check-double me-2 text-primary"></i><?php echo __('voucher_approval'); ?></h5>
        <?php if ($canManage) { ?>
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-4">
            <div class="rateb-approval-stat rateb-approval-stat-total">
                <div class="rateb-approval-stat-label"><?php echo __('total_vouchers'); ?></div>
    ...
    <div class="rateb-card">
        ...
        <div class="rateb-bulk-bar<?php echo empty($items) ? ' d-none' : ''; ?>" data-rateb-bulk-bar>
            ...
            <form method="post" action="<?php echo rateb_app_url('cash-vouchers/bulk-reject'); ?>" class="d-inline flex-wrap gap-1 align-items-center" data-rateb-bulk-form="reject"
            ...
            <form method="post" action="<?php echo rateb_app_url('cash-vouchers/bulk-void'); ?>" class="d-inline" data-rateb-bulk-form="undo"
