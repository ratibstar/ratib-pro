...
<div class="rateb-card mb-3">
    <div class="rateb-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        <span><i class="fas fa-passport me-1"></i> <?php echo __('customs_clearance_costs'); ?> — <?php echo __('purchase_invoice'); ?></span>
        <a href="<?php echo rateb_app_url('customs-clearance-costs'); ?>" class="btn btn-sm btn-outline-secondary">
            <?php echo __('customs_clearance_costs'); ?>
        </a>
    </div>
    <div class="rateb-card-body">
        ...
        <div class="alert alert-light border small mb-3">
            ...
            — <?php echo __('purchase_invoice_no'); ?>: <strong><?php echo Rateb\App\Core\View::escape((string) $invoice['invoice_no']); ?></strong>
            <?php } ?>
        </div>
        <form method="post" action="<?php echo rateb_app_url('customs-clearance-costs/' . $invoiceId); ?>">
            ...
            <div class="mt-4 d-flex gap-2">
                ...
                <a href="<?php echo rateb_app_url('customs-clearance-costs'); ?>" class="btn btn-outline-secondary"><?php echo __('cancel'); ?></a>
                <a href="<?php echo rateb_url(rateb_app_route('purchase-orders') . '/' . (int) ($order['id'] ?? 0)); ?>" class="btn btn-outline-secondary"><?php echo __('purchase_orders'); ?></a>
            </div>
        </form>
    </div>
</div>
