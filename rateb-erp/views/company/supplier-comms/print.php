...
<table class="table table-bordered table-sm mb-3">
    <tbody>
    <tr><th style="width:30%"><?php echo __('comm_date'); ?></th><td><?php echo Rateb\App\Core\View::escape((string) ($item['comm_date'] ?? '')); ?> <?php echo Rateb\App\Core\View::escape(substr((string) ($item['comm_time'] ?? ''), 0, 5)); ?></td></tr>
    ...
    <tr><th><?php echo __('follow_up_date'); ?></th><td><?php echo Rateb\App\Core\View::escape((string) ($item['follow_up_date'] ?? '—')); ?></td></tr>
