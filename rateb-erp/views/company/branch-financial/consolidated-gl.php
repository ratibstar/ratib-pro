...
<tr><td><?php echo Rateb\App\Core\View::escape((string)($line['entry_date']??'')); ?></td><td><?php echo Rateb\App\Core\View::escape((string)($line['entry_no']??'')); ?></td><td><?php echo (int)($line['branch_id']??0); ?></td><td><?php echo Rateb\App\Core\View::escape((string)($line['account_code']??'')); ?></td><td><?php echo number_format((float)($line['debit']??0),2); ?></td><td><?php echo number_format((float)($line['credit']??0),2); ?></td></tr>
<?php } ?>
</tbody></table>
