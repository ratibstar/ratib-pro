...
<table class="table table-sm"><thead><tr><th><?php echo __('branch'); ?></th><?php foreach ($labels as $k=>$lbl) { ?><th><?php echo Rateb\App\Core\View::escape($lbl); ?></th><?php } ?><th><?php echo __('total'); ?></th></tr></thead><tbody>
