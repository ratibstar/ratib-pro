...
<div class="rateb-card">
    <div class="rateb-card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <form method="post" action="<?php echo rateb_url('company/inventory/' . (int) $item['id'] . '/codes/generate'); ?>" class="d-inline">
...
<a href="<?php echo rateb_url('company/inventory'); ?>" class="btn btn-outline-secondary mt-3"><?php echo __('back_to_list'); ?></a>
