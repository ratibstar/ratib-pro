...
/** @var array<string,int> $requests */
/** @var list<array<string,mixed>> $timeline */
?>
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <h1 class="h3 mb-0"><?php echo htmlspecialchars((string) ($title ?? __('eam_platform')), ENT_QUOTES, 'UTF-8'); ?></h1>
        <div class="d-flex gap-2 flex-wrap">
            <a class="btn btn-outline-secondary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eam/calendar')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('eam_calendar'), ENT_QUOTES, 'UTF-8'); ?></a>
            <a class="btn btn-primary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eam/assets/create')), ENT_QUOTES, 'UTF-8'); ?>"><i class="fas fa-plus"></i> <?php echo htmlspecialchars(__('eam_asset_create'), ENT_QUOTES, 'UTF-8'); ?></a>
        </div>
    </div>
    ...
    <div class="row g-3">
            ...
            <div class="table-responsive">
                <table class="table table-striped align-middle">
                    ...
                    <?php foreach (($recent ?? []) as $row): ?>
                        <tr>
                            <td><a href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eam/assets') . '/' . (int) $row['id']), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars((string) ($row['asset_no'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></a></td>
        ...
        <div class="col-lg-5">
            <h2 class="h5"><?php echo htmlspecialchars(__('eam_timeline'), ENT_QUOTES, 'UTF-8'); ?></h2>
