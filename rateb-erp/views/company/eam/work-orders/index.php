...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('eam_work_orders')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eam/work-orders')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 mb-3">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3"><input class="form-control" name="scheduled_start" type="datetime-local"></div>
    ...
    <div class="table-responsive border rounded">
        <table class="table table-hover align-middle mb-0">
            <thead><tr><th><?php echo htmlspecialchars(__('record_id'), ENT_QUOTES, 'UTF-8'); ?></th><th><?php echo htmlspecialchars(__('name'), ENT_QUOTES, 'UTF-8'); ?></th><th><?php echo htmlspecialchars(__('status'), ENT_QUOTES, 'UTF-8'); ?></th><th><?php echo htmlspecialchars(__('date'), ENT_QUOTES, 'UTF-8'); ?></th></tr></thead>
            <tbody>
