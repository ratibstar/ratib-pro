...
<div class="container-fluid py-3">
    ...
    <div class="row g-3">
        ...
        <div class="col-lg-7">
            ...
            <pre class="border rounded p-3 small bg-light" style="max-height:520px;overflow:auto"><?php echo htmlspecialchars(json_encode($evaluation['matches'] ?? [], JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) ?: '{}', ENT_QUOTES, 'UTF-8'); ?></pre>
        </div>
    </div>
</div>
