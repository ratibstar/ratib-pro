...
<div class="container-fluid py-3">
    ...
    <div class="row g-3">
        <div class="col-lg-6">
            ...
            <div class="table-responsive"><table class="table table-sm table-striped"><thead><tr><th>Period</th><th>Won</th><th>Lost</th></tr></thead><tbody>
        ...
        <div class="col-lg-6">
            ...
            <ul class="list-group mb-3">
                <li class="list-group-item d-flex justify-content-between"><span>Won</span><span><?php echo (int) ($wl['won_count'] ?? 0); ?></span></li>
                <li class="list-group-item d-flex justify-content-between"><span>Lost</span><span><?php echo (int) ($wl['lost_count'] ?? 0); ?></span></li>
            </ul>
        ...
        <div class="col-lg-6">
            ...
            <ul class="list-group">
                <li class="list-group-item d-flex justify-content-between"><span>Leads</span><span><?php echo (int) ($funnel['leads'] ?? 0); ?></span></li>
                <li class="list-group-item d-flex justify-content-between"><span>Opportunities</span><span><?php echo (int) ($funnel['opportunities'] ?? 0); ?></span></li>
                <li class="list-group-item d-flex justify-content-between"><span>Quotes accepted</span><span><?php echo (int) ($funnel['quotations_accepted'] ?? 0); ?></span></li>
                <li class="list-group-item d-flex justify-content-between"><span>Customers</span><span><?php echo (int) ($funnel['customers'] ?? 0); ?></span></li>
            </ul>
        </div>
    </div>
</div>
