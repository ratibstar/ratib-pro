...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        ...
        <span class="badge text-bg-secondary">auto-delete: off</span>
    </div>
    <?php if (!empty($error)): ?>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3"><div class="border rounded p-3"><div class="small text-muted">Check errors</div><div class="fs-4"><?php echo (int) ($summary['check_errors'] ?? count($errors)); ?></div></div></div>
    </div>
    <p class="text-muted small">Findings only. Safe remediation suggestions are listed — no automatic deletes, DROP, or data wipe.</p>
    <?php if ($errors !== []): ?>
