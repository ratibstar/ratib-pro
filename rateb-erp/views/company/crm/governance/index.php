    ...
    <div class="row g-3">
        ...
        <div class="col-lg-5">
            ...
            <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('crm/governance/settings')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 mb-2">
                ...
                <div class="fw-semibold mb-1"><?php echo htmlspecialchars(rateb_ui((string) ($s['setting_key'] ?? '')), ENT_QUOTES, 'UTF-8'); ?></div>
                <p class="small text-muted mb-1"><?php echo htmlspecialchars(__('crm_json_setting_help'), ENT_QUOTES, 'UTF-8'); ?></p>
                <textarea class="form-control form-control-sm mb-2" name="setting_json" rows="3" <?php echo empty($canManage) ? 'readonly' : ''; ?> dir="ltr"><?php echo htmlspecialchars((string) ($s['setting_json'] ?? '{}'), ENT_QUOTES, 'UTF-8'); ?></textarea>
