...
<div class="container-fluid py-3">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-3"><div class="border rounded p-3"><div class="small text-muted"><?php echo htmlspecialchars(__('crm_stale_leads_opps_cust'), ENT_QUOTES, 'UTF-8'); ?></div><div class="fs-6"><?php echo (int) ($freshness['stale_leads'] ?? 0); ?> / <?php echo (int) ($freshness['stale_opportunities'] ?? 0); ?> / <?php echo (int) ($freshness['stale_customers'] ?? 0); ?></div></div></div>
    ...
    <div class="row g-3">
        <div class="col-lg-6">
            <h2 class="h5"><?php echo htmlspecialchars(__('crm_suggestions'), ENT_QUOTES, 'UTF-8'); ?></h2>
            ...
            <div class="border rounded p-3 mb-2 small">
                ...
                <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('crm/merge/request')), ENT_QUOTES, 'UTF-8'); ?>" class="mt-2 d-flex gap-2">
                    ...
                    <button class="btn btn-sm btn-outline-primary" type="submit"><?php echo htmlspecialchars(__('crm_request_merge'), ENT_QUOTES, 'UTF-8'); ?></button>
                </form>
                <?php endif; ?>
            </div>
            <?php endforeach; ?>
        ...
        <div class="col-lg-6">
            <h2 class="h5"><?php echo htmlspecialchars(__('crm_pending_merges'), ENT_QUOTES, 'UTF-8'); ?></h2>
            ...
            <div class="border rounded p-3 mb-2">
                ...
                <div class="d-flex gap-2 mt-2">
                    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('crm/merge') . '/' . (int) $p['id'] . '/execute'), ENT_QUOTES, 'UTF-8'); ?>">
                        <input type="hidden" name="_csrf" value="<?php echo htmlspecialchars(\Rateb\App\Core\Csrf::token(), ENT_QUOTES, 'UTF-8'); ?>">
                        <button class="btn btn-sm btn-success" type="submit"><?php echo htmlspecialchars(__('crm_execute'), ENT_QUOTES, 'UTF-8'); ?></button>
                    </form>
                    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('crm/merge') . '/' . (int) $p['id'] . '/reject'), ENT_QUOTES, 'UTF-8'); ?>">
                        <input type="hidden" name="_csrf" value="<?php echo htmlspecialchars(\Rateb\App\Core\Csrf::token(), ENT_QUOTES, 'UTF-8'); ?>">
                        <button class="btn btn-sm btn-outline-danger" type="submit"><?php echo htmlspecialchars(__('crm_reject'), ENT_QUOTES, 'UTF-8'); ?></button>
                    </form>
                </div>
                <?php endif; ?>
            </div>
