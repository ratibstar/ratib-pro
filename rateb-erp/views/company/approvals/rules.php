...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('approval_rules')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('approvals/rules')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 mb-3">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3"><input class="form-control" name="rule_type" value="amount"></div>
