<?php
/** Entry approval table (journal entries list) */
...
<div class="rateb-entry-approval">
    ...
    <div class="rateb-card">
        ...
        <div class="rateb-bulk-bar<?php echo empty($items) ? ' d-none' : ''; ?>" data-rateb-bulk-bar>
            ...
            <form method="post" action="<?php echo rateb_app_url('journal-entries/bulk-delete'); ?>" class="d-inline" data-rateb-bulk-form="reject"
            ...
            <div class="table-responsive">
                <table class="table rateb-table rateb-approval-table mb-0" data-rateb-bulk-table="<?php echo $bulkAny ? '1' : '0'; ?>">
                    ...
                    <?php } else { foreach ($items as $row) {
                        ...
                        $displayStatus = $isPending ? 'pending' : ($isApproved ? 'approved' : $st);
                        $badgeClass = $isPending ? 'warning' : ($isApproved ? 'success' : 'secondary');
                    ...
                    <tr>
                        ...
                        <td class="text-end text-nowrap rateb-approval-actions">
                            ...
                            <form method="post" action="<?php echo rateb_app_url('journal-entries/' . (int) $row['id'] . '/delete'); ?>" class="d-inline"
