...
<?php if (!empty($items) && rateb_can_manage_entity('inventory')) { ?>
<div class="rateb-card mt-3">
    <div class="rateb-card-header"><?php echo __('barcode_qr'); ?></div>
    <div class="rateb-card-body">
        <?php foreach ($items as $row) { ?>
        <a class="btn btn-sm btn-outline-secondary me-1 mb-1" href="<?php echo rateb_app_url('inventory/' . (int) $row['id'] . '/codes'); ?>">
