...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('eproc_rfq_templates')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/rfq-templates')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 col-lg-8 mb-4">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3">
                <label class="form-label"><?php echo htmlspecialchars(__('default_days'), ENT_QUOTES, 'UTF-8'); ?></label>
                <input type="number" name="default_days" class="form-control" value="14" min="1">
            </div>
            <div class="col-12">
                <label class="form-label"><?php echo htmlspecialchars(__('body_template'), ENT_QUOTES, 'UTF-8'); ?></label>
                <textarea name="body_template" class="form-control" rows="3"></textarea>
            </div>
            <div class="col-12">
        ...
        <table class="table table-hover align-middle mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo htmlspecialchars(__('default_days'), ENT_QUOTES, 'UTF-8'); ?></th>
            ...
            <?php foreach (($items ?? []) as $row): ?>
                <tr>
                    ...
                    <td><?php echo (int) ($row['default_days'] ?? 0); ?></td>
