...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('eproc_calendar')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/calendar')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 col-lg-8 mb-4">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3">
                <label class="form-label"><?php echo htmlspecialchars(__('event_type'), ENT_QUOTES, 'UTF-8'); ?></label>
                <input type="text" name="event_type" class="form-control" value="general">
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <label class="form-label"><?php echo htmlspecialchars(__('related_type'), ENT_QUOTES, 'UTF-8'); ?></label>
                <input type="text" name="related_type" class="form-control">
            </div>
            <div class="col-md-3">
                <label class="form-label"><?php echo htmlspecialchars(__('related_id'), ENT_QUOTES, 'UTF-8'); ?></label>
        ...
        <table class="table table-hover align-middle mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo htmlspecialchars(__('event_type'), ENT_QUOTES, 'UTF-8'); ?></th>
                    <th><?php echo htmlspecialchars(__('starts_at'), ENT_QUOTES, 'UTF-8'); ?></th>
                    <th><?php echo htmlspecialchars(__('ends_at'), ENT_QUOTES, 'UTF-8'); ?></th>
            ...
            <?php foreach (($items ?? []) as $row): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars((string) ($row['starts_at'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo htmlspecialchars((string) ($row['ends_at'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
