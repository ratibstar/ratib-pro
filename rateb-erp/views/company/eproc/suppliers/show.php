...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-3">
        ...
        <a class="btn btn-outline-secondary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/suppliers')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('back'), ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="border rounded p-3 mb-3">
                <div><strong><?php echo htmlspecialchars(__('name_ar'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['name_ar'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></div>
                ...
                <div><strong><?php echo htmlspecialchars(__('risk_level'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['risk_level'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></div>
                <div><strong><?php echo htmlspecialchars(__('category'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo (int) ($item['category_id'] ?? 0) ?: '—'; ?></div>
            ...
            <ul class="list-group mb-3">
                <?php foreach (($comments ?? []) as $c): ?>
                    <li class="list-group-item">
                        <div><?php echo nl2br(htmlspecialchars((string) ($c['body'] ?? ''), ENT_QUOTES, 'UTF-8')); ?></div>
            ...
            <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/suppliers') . '/' . (int) $item['id'] . '/comments'), ENT_QUOTES, 'UTF-8'); ?>" class="mb-3">
                ...
                <?php endif; ?>
                <input type="hidden" name="entity_type" value="supplier_profile">
        ...
        <div class="col-lg-4">
            ...
            <div class="border rounded p-3 mb-3">
                ...
                <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/suppliers') . '/' . (int) $item['id'] . '/transition'), ENT_QUOTES, 'UTF-8'); ?>">
                    <?php if (function_exists('csrf_field')): ?>
                        <?php echo csrf_field(); ?>
                    <?php elseif (isset($csrf)): ?>
                        <input type="hidden" name="_csrf" value="<?php echo htmlspecialchars((string) $csrf, ENT_QUOTES, 'UTF-8'); ?>">
