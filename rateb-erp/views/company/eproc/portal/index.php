...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('eproc_portal')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/portal')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 col-lg-6 mb-4">
        ...
        <table class="table table-hover align-middle mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo htmlspecialchars(__('expires_at'), ENT_QUOTES, 'UTF-8'); ?></th>
                    <th><?php echo htmlspecialchars(__('status'), ENT_QUOTES, 'UTF-8'); ?></th>
                    <th><?php echo htmlspecialchars(__('created_at'), ENT_QUOTES, 'UTF-8'); ?></th>
                </tr>
            </thead>
            <tbody>
            <?php foreach (($items ?? []) as $row): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars((string) ($row['expires_at'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
