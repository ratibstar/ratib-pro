...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-3">
        ...
        <a class="btn btn-outline-secondary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/contracts')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('back'), ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="border rounded p-3 mb-3">
                <div><strong><?php echo htmlspecialchars(__('profile_id'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo (int) ($item['profile_id'] ?? 0) ?: '—'; ?></div>
                <div><strong><?php echo htmlspecialchars(__('amount'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars(number_format((float) ($item['value_amount'] ?? 0), 2), ENT_QUOTES, 'UTF-8'); ?> <?php echo htmlspecialchars((string) ($item['currency_code'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div>
                <div><strong><?php echo htmlspecialchars(__('starts_at'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['starts_at'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></div>
                <div><strong><?php echo htmlspecialchars(__('ends_at'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['ends_at'] ?? '—'), ENT_QUOTES, 'UTF-8'); ?></div>
        ...
        <div class="col-lg-4">
            ...
            <div class="border rounded p-3 mb-3">
                ...
                <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('eproc/contracts') . '/' . (int) $item['id'] . '/transition'), ENT_QUOTES, 'UTF-8'); ?>">
