...
<div class="container-fluid py-3">
    ...
    <div class="row g-3 mb-4">
        <div class="col-md-4"><div class="border rounded p-3"><div class="text-muted small"><?php echo htmlspecialchars(__('code'), ENT_QUOTES, 'UTF-8'); ?></div><div class="fw-semibold"><?php echo htmlspecialchars((string) ($item['code'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div></div></div>
        <div class="col-md-4"><div class="border rounded p-3"><div class="text-muted small"><?php echo htmlspecialchars(__('status'), ENT_QUOTES, 'UTF-8'); ?></div><div class="fw-semibold"><?php echo htmlspecialchars((string) ($item['workflow_status'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div></div></div>
        <div class="col-md-4"><div class="border rounded p-3"><div class="text-muted small">version</div><div class="fw-semibold"><?php echo (int) ($item['version'] ?? 1); ?></div></div></div>
    </div>
    <?php if (!empty($canTransition) && ($transitions ?? []) !== []): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('qms/corrective-actions') . '/' . (int) ($item['id'] ?? 0) . '/transition'), ENT_QUOTES, 'UTF-8'); ?>" class="card mb-4">
