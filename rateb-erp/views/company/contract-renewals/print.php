...
<table class="table table-bordered table-sm mb-3">
    ...
    <tr><th><?php echo __('renewal_date'); ?></th><td><?php echo Rateb\App\Core\View::escape((string) ($item['renewal_date'] ?? '—')); ?></td></tr>
    <tr><th><?php echo __('new_end_date'); ?></th><td><?php echo Rateb\App\Core\View::escape((string) ($item['new_end_date'] ?? '—')); ?></td></tr>
    ...
    <tr><th><?php echo __('approved_by'); ?></th><td><?php echo Rateb\App\Core\View::escape((string) $item['approved_by_name']); ?><?php if (!empty($item['approved_at'])) { ?> — <?php echo Rateb\App\Core\View::escape((string) $item['approved_at']); ?><?php } ?></td></tr>
    <?php } ?>
    </tbody>
</table>
