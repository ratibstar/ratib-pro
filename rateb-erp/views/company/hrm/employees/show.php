...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-3">
        <div>
            <h1 class="h3 mb-1"><?php echo htmlspecialchars($name, ENT_QUOTES, 'UTF-8'); ?></h1>
        ...
        <a class="btn btn-outline-secondary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('hrm/employees')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('back'), ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="border rounded p-3 mb-3">
                ...
                <div><strong><?php echo htmlspecialchars(__('hire_date'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['hire_date'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div>
                <div><strong><?php echo htmlspecialchars(__('employment_type'), ENT_QUOTES, 'UTF-8'); ?>:</strong> <?php echo htmlspecialchars((string) ($item['employment_type'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></div>
        ...
        <div class="col-lg-4">
            ...
            <div class="border rounded p-3 mb-3">
                ...
                <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('hrm/employees') . '/' . (int) $item['id'] . '/transition'), ENT_QUOTES, 'UTF-8'); ?>">
