...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('hrm_transfers')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('hrm/transfers')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 col-lg-10 mb-4">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3">
                <label class="form-label"><?php echo htmlspecialchars(__('to_department'), ENT_QUOTES, 'UTF-8'); ?></label>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <?php foreach (($items ?? []) as $row): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars((string) ($row['transfer_status'] ?? $row['status'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                </tr>
            <?php endforeach; ?>
