...
<div class="container-fluid py-3">
    <h1 class="h3 mb-3"><?php echo htmlspecialchars((string) ($title ?? __('mfg_capacity')), ENT_QUOTES, 'UTF-8'); ?></h1>
    <?php if (!empty($canCreate)): ?>
    <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('mfg/capacity')), ENT_QUOTES, 'UTF-8'); ?>" class="border rounded p-3 col-lg-8 mb-4">
        ...
        <div class="row g-2">
            ...
            <div class="col-md-3">
                <label class="form-label">work_center_id</label>
                <input type="number" name="work_center_id" class="form-control" min="1">
            </div>
        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <?php foreach (($items ?? []) as $row): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars((string) ($row['name'] ?? $row['title'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></td>
                    <td><?php echo (int) ($row['work_center_id'] ?? 0); ?></td>
