...
<div class="container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-start gap-2 mb-3">
        <div>
            <h1 class="h3 mb-1"><?php echo htmlspecialchars((string) ($item['title'] ?? $item['name'] ?? ''), ENT_QUOTES, 'UTF-8'); ?></h1>
        ...
        <a class="btn btn-outline-secondary" href="<?php echo htmlspecialchars(rateb_url(rateb_app_route('mfg/work-orders')), ENT_QUOTES, 'UTF-8'); ?>"><?php echo htmlspecialchars(__('back'), ENT_QUOTES, 'UTF-8'); ?></a>
    </div>
    <div class="row g-3">
        <div class="col-lg-8">
            <div class="border rounded p-3 mb-3">
                <div><strong>production_order_id:</strong> <?php echo (int) ($item['production_order_id'] ?? 0); ?></div>
        ...
        <div class="col-lg-4">
            ...
            <div class="border rounded p-3 mb-3">
                ...
                <form method="post" action="<?php echo htmlspecialchars(rateb_url(rateb_app_route('mfg/work-orders') . '/' . (int) $item['id'] . '/transition'), ENT_QUOTES, 'UTF-8'); ?>">
