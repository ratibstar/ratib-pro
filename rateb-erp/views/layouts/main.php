...
<div class="rateb-wrapper">
    <aside class="rateb-sidebar" id="rateb-sidebar">
        ...
        <nav>
            ...
            ?>
            <div class="rateb-nav-section"><?php echo __('users'); ?></div>
        ...
        <header class="rateb-topbar">
            ...
            <div class="d-flex align-items-center gap-2">
                <div class="btn-group btn-group-sm">
                    ...
                    <button type="button" class="btn btn-outline-secondary" data-theme-choice="dark" title="<?php echo __('theme_dark'); ?>"><i class="fas fa-moon"></i></button>
                    <button type="button" class="btn btn-outline-secondary active" data-theme-choice="auto" title="<?php echo __('theme_auto'); ?>"><i class="fas fa-circle-half-stroke"></i></button>
                </div>
                <div class="btn-group btn-group-sm">
                    <a href="<?php echo rateb_url('locale/en'); ?>" class="btn btn-outline-secondary" data-locale="en">EN</a>
                    <a href="<?php echo rateb_url('locale/ar'); ?>" class="btn btn-outline-secondary" data-locale="ar">AR</a>
                </div>
            </div>
        </header>
