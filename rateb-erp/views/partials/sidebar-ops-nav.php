...
$opsSection(__('crm'), [
    ...
    ['crm/revops', 'crm_revops_command_center', 'fa-satellite-dish', 'crm', 'crm.revops.view'],
    ['crm/cockpit', 'crm_executive_cockpit', 'fa-binoculars', 'crm', 'crm.cockpit.view'],
    ['crm/insights', 'crm_executive_insights', 'fa-lightbulb', 'crm', 'crm.insights.view'],
    ['crm/intelligence-layer', 'crm_intelligence_layer', 'fa-microchip', 'crm', 'crm.intelligence.advanced'],
    ['crm/predictive', 'crm_predictive_rules', 'fa-gears', 'crm', 'crm.predictive.manage'],
    ['crm/dashboards', 'crm_advanced_dashboards', 'fa-gauge-high', 'crm', 'crm.dashboards.view'],
    ['crm/search', 'crm_unified_search', 'fa-magnifying-glass', 'crm', 'crm.search.view'],
    ['crm/merge', 'crm_duplicate_merge', 'fa-object-group', 'crm', 'crm.merge.manage'],
    ...
    ['crm/revenue', 'crm_revenue_intelligence', 'fa-chart-pie', 'crm', 'crm.revenue.intel'],
    ['crm/forecast', 'crm_enterprise_forecast', 'fa-chart-area', 'crm', 'crm.forecast.enterprise'],
    ['crm/performance', 'crm_sales_performance_mgmt', 'fa-trophy', 'crm', 'crm.performance.view'],
    ['crm/reports', 'crm_reports', 'fa-chart-line', 'crm', 'crm.reports.view'],
    ['crm/reporting-center', 'crm_reporting_center', 'fa-chart-column', 'crm', 'crm.reporting.center'],
