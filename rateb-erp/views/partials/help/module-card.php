...
?>
<a class="hc-module-card hc-accent-<?php echo htmlspecialchars($accent, ENT_QUOTES, 'UTF-8'); ?>" href="<?php echo htmlspecialchars($url, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <span class="hc-module-card__body">
        <span class="hc-module-card__title"><?php echo Rateb\App\Core\View::escape((string) ($module['title'] ?? '')); ?></span>
        <span class="hc-module-card__desc"><?php echo Rateb\App\Core\View::escape((string) ($module['description'] ?? '')); ?></span>
