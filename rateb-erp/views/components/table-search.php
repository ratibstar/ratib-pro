...
<div class="rateb-table-search" data-rateb-table-search-wrap="1"<?php echo $mode === 'server' ? ' data-rateb-server-search="1"' : ''; ?>>
    <?php if ($mode === 'server') { ?>
    <form method="get" action="<?php echo rateb_url($routePrefix); ?>" class="rateb-table-search-form" data-rateb-table-search-form="1">
        ...
        <div class="rateb-table-search-row">
            <div class="input-group input-group-sm rateb-table-search-input">
                ...
                <?php if ($search !== '') { ?>
                <a href="<?php echo rateb_list_url($routePrefix, rateb_list_query_except(['q'])); ?>" class="btn btn-outline-secondary" title="<?php echo __('clear'); ?>">
