...
<div class="d-flex flex-wrap gap-2<?php echo !empty($inline) ? '' : ' mb-3'; ?>">
    ...
    <a href="<?php echo Rateb\App\Core\View::escape($exportPdf); ?>" class="btn btn-sm btn-outline-secondary" target="_blank" rel="noopener noreferrer"><i class="fas fa-file-pdf"></i> PDF / Print</a>
</div>
