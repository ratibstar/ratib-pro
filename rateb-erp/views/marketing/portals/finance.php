<section class="rateb-portal-section">
    <div class="container">
        ...
        <p class="rateb-portal-lead"><?php echo __('outstanding_balance') ?: 'Outstanding balance'; ?>: <strong><?php echo number_format((float) ($outstanding ?? 0), 2); ?></strong></p>
        <h2><?php echo __('invoices') ?: 'Invoices'; ?></h2>
        <table class="rateb-portal-table">
            <thead><tr><th><?php echo __('invoice_no') ?: 'Invoice'; ?></th><th><?php echo __('amount') ?: 'Amount'; ?></th><th><?php echo __('status') ?: 'Status'; ?></th><th><?php echo __('due_date') ?: 'Due'; ?></th></tr></thead>
            <tbody>
