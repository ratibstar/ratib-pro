...
UPDATE rateb_permissions SET
    name_ar = CONVERT(UNHEX('D9D884D988D98320D8A7D984D981D8B1D988D8B9') USING utf8mb4),
    description_ar = CONVERT(UNHEX('D8B9D8B1D8B620D985D8A4D8B4D8B1D8A720D8A7D984D8A3D8AFD8A720D9D884D984D981D8B1D988D8B9') USING utf8mb4)
...
UPDATE rateb_permissions SET
    name_ar = CONVERT(UNHEX('D8AAD9D982D8A7D8B1D98020D8A7D984D981D8B1D988D8B9') USING utf8mb4),
    description_ar = CONVERT(UNHEX('D8AAD9D982D8A7D8B1D98020D8A5D8AFD8A7D8B1D98020D8A7D984D981D8B1D988D8B9') USING utf8mb4)
WHERE slug = 'branch.reports.view';

UPDATE rateb_permissions SET
    name_ar = CONVERT(UNHEX('D8B9D8B1D8B620D8A7D984D8AAD8AD988D98420D8A8D98AD98620D8A7D984D981D8B1D988D8B9') USING utf8mb4),
    description_ar = CONVERT(UNHEX('D8B9D8B1D8B620D8B7D984D8A8D8A7D8AA20D8A7D984D8AAD8AD988D98420D8A8D98AD98620D8A7D984D981D8B1D988D8B9') USING utf8mb4)
WHERE slug = 'branch.transfers.view';

UPDATE rateb_permissions SET
    name_ar = CONVERT(UNHEX('D8A5D8AFD8A7D8B1D8A920D8A7D984D8AAD8AD988D98420D8A8D98AD98620D8A7D984D981D8B1D988D8B9') USING utf8mb4),
    description_ar = CONVERT(UNHEX('D8A5D986D8B4D8A7D8A120D988D8A7D8B9D8AAD985D8A7D8AF20D8A7D984D8AAD8AD988D98420D8A8D98AD98620D8A7D984D981D8B1D988D8B9') USING utf8mb4)
