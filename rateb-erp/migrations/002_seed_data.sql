...
VALUES
('Launch', 'launch', 'Start with the control panel, alerts, and essential reporting', 39.00, 351.00, 3, 256, '["dashboard","notifications","profile","reports"]', 1),
('Starter', 'starter', 'Core purchasing operations for clinics and small establishments', 69.00, 621.00, 8, 512, '["dashboard","notifications","profile","reports","procurement","inventory","suppliers"]', 1),
('Commerce', 'commerce', 'Sell, stock, and deliver with POS, logistics, and marketplace', 99.00, 891.00, 20, 2048, '["dashboard","notifications","profile","reports","procurement","inventory","suppliers","pos","logistics","marketplace","branches"]', 1),
('Professional', 'professional', 'Grow with HR, CRM, projects, accounting, and approvals', 129.00, 1161.00, 50, 5120, '["dashboard","notifications","profile","reports","procurement","inventory","suppliers","pos","logistics","marketplace","branches","hr","recruitment","crm","projects","approval","accounting","assets","contracts","documents","workflows"]', 1),
