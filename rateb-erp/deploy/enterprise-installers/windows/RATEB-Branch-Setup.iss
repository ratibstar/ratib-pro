; RATEB ERP — Phase D.2 Enterprise Branch Appliance
; Inno Setup 6 — produces RATEB-Branch-Setup.exe
; Silent: RATEB-Branch-Setup.exe /SILENT
; Repair: re-run setup (preserves storage\branch SQLite)

#define MyAppName "RATEB Branch"
#define MyAppVersion "1.0.0"
#define MyAppPublisher "RATEB"
#define MyAppURL "https://rateb.sa"
#define MyAppExeName "Open RATEB Branch.url"
#define InstallDirName "RATEB Branch"
...
DefaultGroupName=RATEB Branch
DisableProgramGroupPage=no
LicenseFile=
OutputDir=..\..\..\storage\branch\enterprise-installers
OutputBaseFilename=RATEB-Branch-Setup
Compression=lzma2
...
MinVersion=10.0
WizardStyle=modern
UninstallDisplayName=RATEB Branch
...
Source: "*"; DestDir: "{app}\deploy\enterprise-installers\windows"; Flags: ignoreversion; Excludes: "build.ps1,RATEB-Branch-Setup.iss"
...
[Icons]
Name: "{group}\RATEB ERP"; Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File ""{app}\deploy\enterprise-installers\zero-touch\windows\RatebLauncher.ps1"" -InstallRoot ""{app}"""
Name: "{group}\Uninstall RATEB Branch"; Filename: "{uninstallexe}"
Name: "{autodesktop}\RATEB ERP"; Filename: "powershell.exe"; Parameters: "-NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -File ""{app}\deploy\enterprise-installers\zero-touch\windows\RatebLauncher.ps1"" -InstallRoot ""{app}"""; Tasks: desktopicon
...
Filename: "http://127.0.0.1/"; Description: "Open RATEB Branch"; Flags: postinstall shellexec skipifsilent
