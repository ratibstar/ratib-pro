...
(function (root) {
    ...
    function registerSw() {
        var expectedCache = 'rateb-offline-v2-bootstrap-v16';
    ...
    function run() {
        ...
        var BUSINESS_MODULE_REGISTRY = [
            ...
            },
            {
                id: 'pos',
                title: 'POS',
                routes: ['/pos', '/pos/product', '/pos/cart', '/pos/checkout', '/pos/stock', '/pos/recovery', '/pos/sync-preview', '/pos/sales', '/pos/settings'],
