...
(function (root) {
    ...
    function registerSw() {
        var expectedCache = 'rateb-offline-v2-bootstrap-v21';
    ...
    function run() {
        ...
        var BUSINESS_MODULE_REGISTRY = [
            ...
            },
            {
                id: 'pos',
                title: 'POS',
                routes: ['/pos', '/pos/product', '/pos/cart', '/pos/checkout', '/pos/stock', '/pos/recovery', '/pos/sync-preview', '/pos/conflicts', '/pos/sync', '/pos/sync-cert', '/pos/accept-cert', '/pos/cert', '/pos/sales', '/pos/settings'],
                ...
                scripts: [
                    ...
                    './js/modules/pos/pos-sync-gateway.js',
                    './js/modules/pos/pos-sync-cert.js',
                    './js/modules/pos/pos-accept-cert.js',
