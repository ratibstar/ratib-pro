/*!
 * RATEB Offline V2 — Host boot (Phases 1–9 self-tests).
 */
(function (root) {
    'use strict';
    ...
    function run() {
        ...
        return hci.ensureLayout().then(function (layout) {
            ...
            return hci.appendLog('phase9-host-boot');
        }).then(function () {
            return registerSw();
        }).then(function (sw) {
                                ...
                                return runSdkSelfTest().then(function (sdkRes) {
                                    return runBusinessSelfTest().then(function (bmRes) {
                                        ...
                                        setText('boot-status', ok
                                            ? 'Phase 9 platform + Business Module Framework + ReferenceModule ready'
                                            : 'Phase 9 self-test failed');
