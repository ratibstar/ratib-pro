# Zero-touch proof — Offline V1 + locked layers (Phase 17 Manufacturing)
...
git diff --name-only HEAD -- \
  ...
  rateb-erp/public/v2/js/business/crm-module.js \
  rateb-erp/public/v2/js/business/hr-module.js \
  rateb-erp/public/v2/js/business/business-module-framework.js \
  rateb-erp/modules/pos
```

Expected: empty for frozen paths (MFG artifacts only under manufacturing-module + host wiring + P17 docs).
