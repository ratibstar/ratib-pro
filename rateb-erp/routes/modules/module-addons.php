...
$router->get('/admin/billing/addon-locks', [ModuleAddonDemoPreviewController::class, 'locks'], $previewMw);
$router->post('/admin/billing/addon-locks', [ModuleAddonDemoPreviewController::class, 'toggleLocks'], $previewMw);
