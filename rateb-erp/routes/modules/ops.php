...
$router->get($app('hr/saudi-compliance'), [HrSaudiComplianceController::class, 'index'], $hrEmpMwDec);
$router->post($app('hr/saudi-compliance/employee'), [HrSaudiComplianceController::class, 'saveEmployee'], $hrEmpMwDec);
$router->post($app('hr/saudi-compliance/gosi-build'), [HrSaudiComplianceController::class, 'buildGosi'], $hrEmpMwDec);
...
foreach ($hrCrudRoutes as $path => $cfg) {
    ...
    if ($path === 'hr/employees') {
        ...
        $router->get($app('hr/employees/lookup'), [HrEmployeesController::class, 'lookup'], $mw);
...
$router->get($app('accounting/zatca-onboarding'), [CompanyAccountingDashboardController::class, 'zatcaOnboarding'], rateb_erp_mw('accounting', '', 'zatca-onboarding'));
$router->post($app('accounting/zatca-onboarding/link'), [CompanyAccountingDashboardController::class, 'zatcaOnboardingLink'], rateb_erp_mw('accounting', 'accounting.manage', 'zatca-onboarding'));
$router->post($app('accounting/zatca-onboarding/unlink'), [CompanyAccountingDashboardController::class, 'zatcaOnboardingUnlink'], rateb_erp_mw('accounting', 'accounting.manage', 'zatca-onboarding'));
$router->post($app('accounting/zatca-onboarding/environment'), [CompanyAccountingDashboardController::class, 'zatcaOnboardingEnvironment'], rateb_erp_mw('accounting', 'accounting.manage', 'zatca-onboarding'));
$router->post($app('accounting/zatca-onboarding/serial'), [CompanyAccountingDashboardController::class, 'zatcaOnboardingSerial'], rateb_erp_mw('accounting', 'accounting.manage', 'zatca-onboarding'));
