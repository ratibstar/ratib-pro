...
$router->post($app('crm/revops/automation'), [CrmRevOpsController::class, 'runAutomation'], rateb_erp_mw('crm', 'crm.revops.view', 'crm'));
...
$router->post($app('crm/insights/{id}/dismiss'), [CrmInsightsController::class, 'dismiss'], rateb_erp_mw('crm', 'crm.insights.view', 'crm'));
