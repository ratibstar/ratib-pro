...
$router->post('/site/customer/finance/pay', [\Rateb\App\Controllers\Marketing\PortalInvoicePaymentController::class, 'pay'], $cmw);
$router->get('/site/customer/finance/payment/callback', [\Rateb\App\Controllers\Marketing\PortalInvoicePaymentController::class, 'callback'], $cmw);
$router->get('/site/customer/finance/payment/success', [\Rateb\App\Controllers\Marketing\PortalInvoicePaymentController::class, 'success'], $cmw);
