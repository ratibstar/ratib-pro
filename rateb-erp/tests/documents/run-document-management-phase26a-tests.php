...
/**
 * Phase 26A — Enterprise Document Management Online test runner.
 *
...
require_once __DIR__ . '/DocumentManagementPhase26ATest.php';

$results = (new DocumentManagementPhase26ATest())->run();
