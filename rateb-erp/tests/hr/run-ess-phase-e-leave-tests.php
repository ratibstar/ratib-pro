...
/**
 * Phase E ESS leave test runner.
 *
 * php tests/hr/run-ess-phase-e-leave-tests.php
 */
...
require_once __DIR__ . '/EssPhaseELeaveTest.php';

$results = (new EssPhaseELeaveTest())->run();
