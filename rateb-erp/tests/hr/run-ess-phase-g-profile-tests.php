...
/**
 * Phase G ESS profile test runner.
 *
 * php tests/hr/run-ess-phase-g-profile-tests.php
 */
...
require_once __DIR__ . '/EssPhaseGProfileTest.php';

$results = (new EssPhaseGProfileTest())->run();
