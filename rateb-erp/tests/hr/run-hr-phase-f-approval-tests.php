...
/**
 * Phase F HR approval inbox test runner.
 *
 * php tests/hr/run-hr-phase-f-approval-tests.php
 */
...
require_once __DIR__ . '/HrPhaseFApprovalTest.php';

$results = (new HrPhaseFApprovalTest())->run();
