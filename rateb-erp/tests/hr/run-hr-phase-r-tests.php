...
/**
 * Phase R Saudi compliance test runner.
 *
 * php tests/hr/run-hr-phase-r-tests.php
 */
...
require_once __DIR__ . '/HrPhaseRSaudiComplianceTest.php';

$results = (new HrPhaseRSaudiComplianceTest())->run();
