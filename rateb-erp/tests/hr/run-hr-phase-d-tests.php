...
/**
 * Phase D HR payroll correctness test runner.
 *
 * php tests/hr/run-hr-phase-d-tests.php
 */
...
require_once __DIR__ . '/HrPhaseDSecurityTest.php';

$results = (new HrPhaseDSecurityTest())->run();
