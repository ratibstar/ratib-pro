...
/**
 * Phase N HR Command Center test runner.
 *
 * php tests/hr/run-hr-phase-n-tests.php
 */
...
require_once __DIR__ . '/HrPhaseNCommandCenterTest.php';

$results = (new HrPhaseNCommandCenterTest())->run();
