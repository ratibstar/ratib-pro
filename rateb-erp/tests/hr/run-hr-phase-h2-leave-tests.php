...
/**
 * Phase H2 leave integrity test runner.
 *
 * php tests/hr/run-hr-phase-h2-leave-tests.php
 */
...
require_once __DIR__ . '/HrPhaseH2LeaveTest.php';

$results = (new HrPhaseH2LeaveTest())->run();
