...
/**
 * Phase M Decisions + Disciplinary test runner.
 *
 * php tests/hr/run-hr-phase-m-tests.php
 */
...
require_once __DIR__ . '/HrPhaseMDecisionsTest.php';

$results = (new HrPhaseMDecisionsTest())->run();
