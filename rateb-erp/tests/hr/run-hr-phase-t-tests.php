...
/**
 * Phase T Enterprise Hardening test runner.
 *
 * php tests/hr/run-hr-phase-t-tests.php
 */
...
require_once __DIR__ . '/HrPhaseTEnterpriseTest.php';

$results = (new HrPhaseTEnterpriseTest())->run();
