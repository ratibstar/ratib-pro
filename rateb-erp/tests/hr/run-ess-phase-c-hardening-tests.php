...
/**
 * Phase C ESS hardening test runner.
 *
 * php tests/hr/run-ess-phase-c-hardening-tests.php
 */
...
require_once __DIR__ . '/EssPhaseCHardeningTest.php';

$results = (new EssPhaseCHardeningTest())->run();
