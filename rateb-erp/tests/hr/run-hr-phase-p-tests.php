...
/**
 * Phase P ESS + Manager test runner.
 *
 * php tests/hr/run-hr-phase-p-tests.php
 */
...
require_once __DIR__ . '/HrPhasePEssManagerTest.php';

$results = (new HrPhasePEssManagerTest())->run();
