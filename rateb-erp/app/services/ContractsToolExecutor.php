...
/**
 * Contracts Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class ContractsToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_contracts' => 
  array (
    'desc' => 'List commercial contracts (tenant-scoped).',
    'table' => 'rateb_contracts',
    'sql' => 'SELECT id, contract_no, title, party_name, status, start_date, end_date, value, currency, created_at
                          FROM rateb_contracts WHERE company_id = :cid',
    'search_cols' => 
    array (
      0 => 'contract_no',
      1 => 'title',
  ...
  'get_contract' => 
  array (
    'desc' => 'Get one contract by ID.',
    'kind' => 'get',
    'table' => 'rateb_contracts',
    'sql' => 'SELECT * FROM rateb_contracts WHERE id = :id AND company_id = :cid LIMIT 1',
  ),
  'list_expiring_contracts' => 
  array (
    'desc' => 'List contracts expiring within N days (default 60).',
    'kind' => 'expiring',
    'table' => 'rateb_contracts',
    'date_col' => 'end_date',
  ),
  ...
  array (
    'desc' => 'Contracts status summary from live data.',
    'kind' => 'group_count',
    'table' => 'rateb_contracts',
    'group' => 'status',
  ),
