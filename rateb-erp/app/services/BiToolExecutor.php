...
/**
 * Business Intelligence Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class BiToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_bi_dashboards' => 
  array (
    'desc' => 'List BI dashboards (tenant-scoped).',
    'table' => 'rateb_bi_dashboards',
    'sql' => 'SELECT id, name, status, is_default, updated_at, created_at
                          FROM rateb_bi_dashboards WHERE company_id = :cid',
    'search_cols' => 
    array (
      0 => 'name',
    ),
  ...
  'list_bi_kpis' => 
  array (
    'desc' => 'List BI KPIs (tenant-scoped).',
    'table' => 'rateb_bi_kpis',
    'sql' => 'SELECT id, code, name, unit, status, target_value, created_at
                          FROM rateb_bi_kpis WHERE company_id = :cid',
    'search_cols' => 
    array (
      0 => 'code',
      1 => 'name',
  ...
  'list_bi_alerts' => 
  array (
    'desc' => 'List BI alerts (tenant-scoped).',
    'table' => 'rateb_bi_alerts',
    'sql' => 'SELECT id, kpi_id, severity, status, message, triggered_at, created_at
                          FROM rateb_bi_alerts WHERE company_id = :cid',
    'status_col' => 'status',
    'order' => 'id DESC',
  ),
  'bi_kpi_summary' => 
  array (
    'desc' => 'BI KPI/alerts summary from live data.',
    'kind' => 'bi_summary',
  ),
);
