...
/**
 * Notifications Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class NotificationsToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_notifications' => 
  array (
    'desc' => 'List recent notifications for the company (tenant-scoped).',
    'table' => 'rateb_notifications',
    'sql' => 'SELECT id, user_id, title, body, category, is_read, created_at
                          FROM rateb_notifications WHERE company_id = :cid',
    'order' => 'id DESC',
  ),
  'list_unread_notifications' => 
  array (
    'desc' => 'List unread notifications (tenant-scoped).',
    'kind' => 'unread_notifications',
  ),
  'notifications_digest' => 
  array (
    'desc' => 'Notifications digest: unread count and recent categories.',
