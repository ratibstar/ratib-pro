...
/**
 * Assets Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class AssetsToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_assets' => 
  array (
    'desc' => 'List assets (tenant-scoped). Prefers EAM table when present.',
    'kind' => 'assets_list',
  ),
  'get_asset' => 
  array (
    'desc' => 'Get one asset by ID (EAM or legacy).',
    'kind' => 'assets_get',
  ),
  'list_asset_work_orders' => 
  array (
    'desc' => 'List EAM work orders when available.',
    'table' => 'rateb_eam_work_orders',
    'sql' => 'SELECT id, asset_id, work_order_no, status, priority, scheduled_at, completed_at, created_at
                          FROM rateb_eam_work_orders WHERE company_id = :cid',
    'status_col' => 'status',
    'order' => 'id DESC',
  ),
  'assets_summary' => 
  array (
    'desc' => 'Assets status summary from live data.',
    'kind' => 'assets_summary',
  ),
);
