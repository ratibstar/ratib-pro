...
/**
 * Approvals Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class ApprovalsToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_approval_requests' => 
  array (
    'desc' => 'List enterprise approval requests (EAP) when available.',
    'table' => 'rateb_eap_requests',
    'sql' => 'SELECT id, request_no, template_id, status, requester_id, entity_type, entity_id, created_at
                          FROM rateb_eap_requests WHERE company_id = :cid',
    'status_col' => 'status',
    'order' => 'id DESC',
  ),
  'get_approval_request' => 
  array (
    'desc' => 'Get one EAP approval request by ID.',
    'kind' => 'get',
    'table' => 'rateb_eap_requests',
    'sql' => 'SELECT * FROM rateb_eap_requests WHERE id = :id AND company_id = :cid LIMIT 1',
  ),
  'list_pending_eap_requests' => 
  array (
    'desc' => 'List pending EAP approval requests.',
    'kind' => 'pending_eap',
  ),
  'approvals_inbox_summary' => 
  array (
    'desc' => 'Approvals inbox summary by status from live EAP data.',
    'kind' => 'group_count',
    'table' => 'rateb_eap_requests',
    'group' => 'status',
  ),
