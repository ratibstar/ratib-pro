...
/**
 * Projects Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class ProjectsToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_projects' => 
  array (
    'desc' => 'List projects (tenant-scoped).',
    'table' => 'rateb_projects',
    'sql' => 'SELECT id, code, name, status, start_date, end_date, manager_id, budget, progress, created_at
                          FROM rateb_projects WHERE company_id = :cid',
    'search_cols' => 
    array (
      0 => 'code',
      1 => 'name',
  ...
  array (
    ...
    'kind' => 'get',
    'table' => 'rateb_projects',
    'sql' => 'SELECT * FROM rateb_projects WHERE id = :id AND company_id = :cid LIMIT 1',
  ),
  'list_project_tasks' => 
  array (
    'desc' => 'List project tasks (tenant-scoped). Optional project_id.',
    'table' => 'rateb_project_tasks',
    'sql' => 'SELECT id, project_id, title, status, priority, due_date, assignee_id, progress, created_at
                          FROM rateb_project_tasks WHERE company_id = :cid',
    'extra_int' => 
    array (
  ...
  array (
    'desc' => 'Projects status summary from live data.',
    'kind' => 'group_count',
    'table' => 'rateb_projects',
    'group' => 'status',
  ),
