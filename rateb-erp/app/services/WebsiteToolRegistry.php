...
/**
 * Website / CMS Tool Registry — READ tools for Unified ERP Agent.
 */
final class WebsiteToolRegistry
{
    public static function getTools(): array
    {
        return [
            'list_cms_pages' => [
                'name' => 'list_cms_pages',
                'description' => 'List CMS pages (tenant-scoped).',
            ...
            'list_cms_leads' => [
                'name' => 'list_cms_leads',
                'description' => 'List CMS leads (tenant-scoped).',
                'permission' => 'website.view',
                'module' => 'website',
                'write' => false,
                'parameters' => [
            ...
            'list_website_form_submissions' => [
                'name' => 'list_website_form_submissions',
                'description' => 'List website form submissions (tenant-scoped).',
                'permission' => 'website.view',
                'module' => 'website',
                'write' => false,
                'parameters' => [
            ...
            'website_content_summary' => [
                'name' => 'website_content_summary',
                'description' => 'Website/CMS content summary from live pages and leads.',
                'permission' => 'website.view',
                'module' => 'website',
                'write' => false,
                'parameters' => [
