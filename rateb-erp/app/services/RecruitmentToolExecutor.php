...
/**
 * Recruitment Tool Executor — tenant-scoped READ against live ERP tables.
 */
final class RecruitmentToolExecutor
{
    /** @var array<string, array<string, mixed>> */
    private const TOOLS = array (
  'list_recruitment_candidates' => 
  array (
    'desc' => 'List recruitment candidates (tenant-scoped).',
    'table' => 'rateb_recruitment_candidates',
    'sql' => 'SELECT id, full_name, email, phone, status, nationality, job_title, agency_id, created_at
                          FROM rateb_recruitment_candidates WHERE company_id = :cid',
    'search_cols' => 
    array (
      0 => 'full_name',
      1 => 'email',
  ...
  array (
    'desc' => 'Get one recruitment candidate by ID.',
    'kind' => 'get',
    'table' => 'rateb_recruitment_candidates',
    'sql' => 'SELECT * FROM rateb_recruitment_candidates WHERE id = :id AND company_id = :cid LIMIT 1',
  ),
  'list_recruitment_interviews' => 
  array (
    'desc' => 'List recruitment interviews (tenant-scoped).',
    'table' => 'rateb_recruitment_interviews',
    'sql' => 'SELECT id, candidate_id, interview_date, interview_type, status, result, notes, created_at
                          FROM rateb_recruitment_interviews WHERE company_id = :cid',
    'status_col' => 'status',
    'order' => 'id DESC',
  ),
  'recruitment_pipeline_summary' => 
  array (
    'desc' => 'Recruitment pipeline summary by candidate status from live data.',
    'kind' => 'group_count',
    'table' => 'rateb_recruitment_candidates',
    'group' => 'status',
  ),
