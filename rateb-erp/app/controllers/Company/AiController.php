...
final class AiController extends Controller
{
    ...
    private function fallbackPlatformCapabilities(): array
    {
        $defs = [
            ...
            ['id' => 'sales', 'label' => 'ai_cap_sales', 'prompt' => 'ai_suggest_sales', 'domain' => 'sales'],
            ['id' => 'crm', 'label' => 'ai_cap_crm', 'prompt' => 'ai_suggest_crm', 'domain' => 'crm'],
            ['id' => 'logistics', 'label' => 'ai_cap_logistics', 'prompt' => 'ai_suggest_logistics', 'domain' => 'logistics'],
            ['id' => 'hr', 'label' => 'ai_cap_hr', 'prompt' => 'ai_suggest_hr', 'domain' => 'hr'],
            ['id' => 'recruitment', 'label' => 'ai_cap_recruitment', 'prompt' => 'ai_suggest_recruitment', 'domain' => 'recruitment'],
            ['id' => 'projects', 'label' => 'ai_cap_projects', 'prompt' => 'ai_suggest_projects', 'domain' => 'projects'],
            ['id' => 'contracts', 'label' => 'ai_cap_contracts', 'prompt' => 'ai_suggest_contracts', 'domain' => 'contracts'],
            ['id' => 'assets', 'label' => 'ai_cap_assets', 'prompt' => 'ai_suggest_assets', 'domain' => 'assets'],
            ['id' => 'payroll', 'label' => 'ai_cap_payroll', 'prompt' => 'ai_suggest_payroll', 'domain' => 'payroll'],
            ['id' => 'manufacturing', 'label' => 'ai_cap_manufacturing', 'prompt' => 'ai_suggest_manufacturing', 'domain' => 'manufacturing'],
            ['id' => 'quality', 'label' => 'ai_cap_quality', 'prompt' => 'ai_suggest_quality', 'domain' => 'quality'],
            ['id' => 'approvals', 'label' => 'ai_cap_approvals', 'prompt' => 'ai_suggest_approvals', 'domain' => 'approvals'],
            ['id' => 'marketplace', 'label' => 'ai_cap_marketplace', 'prompt' => 'ai_suggest_marketplace', 'domain' => 'marketplace'],
            ['id' => 'accounting', 'label' => 'ai_cap_accounting', 'prompt' => 'ai_suggest_accounting', 'domain' => 'accounting'],
            ['id' => 'bi', 'label' => 'ai_cap_bi', 'prompt' => 'ai_suggest_bi', 'domain' => 'bi'],
            ['id' => 'website', 'label' => 'ai_cap_website', 'prompt' => 'ai_suggest_website', 'domain' => 'website'],
            ['id' => 'notifications', 'label' => 'ai_cap_notifications', 'prompt' => 'ai_suggest_notifications', 'domain' => 'notifications'],
