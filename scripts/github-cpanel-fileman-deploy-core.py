...
FAST_FILES = [
    ...
    "pages/government-workforce-operations.php",
    "pages/enterprise-pack.php",
    "css/rateb-enterprise-tokens.css",
    "css/pages/enterprise-trust-hub.css",
    "public/sitemap.xml",
    "public/robots.txt",
    ...
    "pages/ratib-rebrand-status.php",
    ...
    "modules/infrastructure-marketplace/Verification/EnvironmentVerifier.php",
